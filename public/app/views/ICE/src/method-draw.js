    ...
    window.methodDraw = (function ($) {
        ...
        (uiStrings = Editor.uiStrings =
          {
            ...
            notification: {
              ...
              saveFromBrowser:
                'Select "Save As..." in your browser to save this image as a %s file.',
      ...
      Editor.init = function () {
        ...
        $(".touch nav li").on("touchstart", function () {
          if ($(this).hasClass("open")) {
            $(this)
              .children(".touch .second-level-menu")
              .css("display", "none");
      ...
      */
          ...
          $("#send-sheet-equation-button").on("click touchstart", function () {
            ...
            let message_attachment = {
              "svg-source": btoa(
                unescape(
                  encodeURIComponent(
                    $("#svgcontent").find(".active-layer").html(),
                  ),
                ),
              ),
            };
        ...
        let updateLatexPreview = function () {
          let tex = window.Tool.RecognitionTool.getTex();
          parent.window.svg_source = btoa(
            unescape(
              encodeURIComponent($("#svgcontent").find(".active-layer").html()),
            ),
          );
        ...
        var sendAsImage = function () {
          var svgSource =
            "<svg id='pre-render-svg' style='background-color: #FFFFFF;'><g>" +
            $("#svgcontent").find(".active-layer").html() +
            "</g></svg>";
          ...
          $("#pre-render-svg")
            .find("g")
            .prepend(
              '<rect width="3000" height="3000" x="-500" y="-500" stroke="#000" fill="white" style="pointer-events:none" opacity="1"></rect>',
            );
          $("#pre-render-svg")[0].setAttribute(
            "viewBox",
            parseInt(bbox.x) -
              20 +
              " " +
              (parseInt(bbox.y) - 20) +
              " " +
              (parseInt(bbox.width) + 40) +
              " " +
              (parseInt(bbox.height) + 40),
          );
          ...
          canvg(canvas, $("#pre-render-svg")[0].outerHTML, {
            renderCallback: function () {
              setTimeout(function () {
                ...
                $(
                  parent.document.getElementById("send-message-button"),
                ).click();
        ...
        var clickExport = function () {
          ...
          if (!customHandlers.pngsave) {
            ...
            exportWindow = window.open(
              "data:text/html;charset=utf-8,<title>" +
                str +
                "</title><h1>" +
                str +
                "</h1>",
        ...
        var saveSourceEditor = function () {
          ...
          if (!svgCanvas.setSvgString($("#svg_source_textarea").val())) {
            $.confirm(
              uiStrings.notification.QerrorsRevertToSource,
              function (ok) {
                if (!ok) return false;
                saveChanges();
              },
      ...
      if(svgedit.browser.isIE()) {
        ...
        function promptImgURL() {
          ...
          $.prompt(
            uiStrings.notification.enterNewImgURL,
            curhref,
            function (url) {
              ...
              if (file.type.indexOf("image") !== -1) {
                ...
                reader.onloadend = function (e) {
                  ...
                  img.onload = function () {
                    ...
                    let insertHeight =
                      imgWidth > 300 ? 300 * (imgHeight / imgWidth) : imgHeight;
