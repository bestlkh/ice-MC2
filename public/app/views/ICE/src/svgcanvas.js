...
keyHash["a"] = [ svgEditSymbols.lowercase_a, svgEditSymbols.lowercase_alpha, svgEditSymbols.uppercase_a, svgEditSymbols.symbol_for_all, svgEditSymbols.symbol_wedge];
...
keyHash["c"] = [ svgEditSymbols.lowercase_c, svgEditSymbols.uppercase_c, svgEditSymbols.symbol_ring_operator, svgEditSymbols.symbol_doublestruck_capital_c];
keyHash["d"] = [ svgEditSymbols.lowercase_d, svgEditSymbols.uppercase_d, svgEditSymbols.uppercase_delta, svgEditSymbols.lowercase_delta, svgEditSymbols.symbol_partial_differential];
...
keyHash["f"] = [ svgEditSymbols.lowercase_f, svgEditSymbols.uppercase_f];
keyHash["g"] = [ svgEditSymbols.lowercase_g, svgEditSymbols.lowercase_gamma, svgEditSymbols.uppercase_g, svgEditSymbols.uppercase_gamma];
keyHash["h"] = [ svgEditSymbols.lowercase_h, svgEditSymbols.uppercase_h];
keyHash["i"] = [ svgEditSymbols.lowercase_i, svgEditSymbols.lowercase_iota, svgEditSymbols.symbol_infinity, svgEditSymbols.symbol_integral, svgEditSymbols.uppercase_i, svgEditSymbols.uppercase_iota];
keyHash["j"] = [ svgEditSymbols.lowercase_j, svgEditSymbols.uppercase_j];
keyHash["k"] = [ svgEditSymbols.lowercase_k, svgEditSymbols.lowercase_kappa, svgEditSymbols.uppercase_k, svgEditSymbols.uppercase_kappa];
keyHash["l"] = [ svgEditSymbols.lowercase_l, svgEditSymbols.lowercase_lamda, svgEditSymbols.uppercase_l, svgEditSymbols.uppercase_lambda];
keyHash["m"] = [ svgEditSymbols.lowercase_m, svgEditSymbols.lowercase_mu, svgEditSymbols.uppercase_m, svgEditSymbols.uppercase_mu];
keyHash["n"] = [ svgEditSymbols.lowercase_n, svgEditSymbols.lowercase_nu, svgEditSymbols.uppercase_n,svgEditSymbols.uppercase_nu];
keyHash["o"] = [ svgEditSymbols.lowercase_o, svgEditSymbols.lowercase_omega, svgEditSymbols.lowercase_omicron, svgEditSymbols.uppercase_o, svgEditSymbols.uppercase_omega, svgEditSymbols.uppercase_omicron];
keyHash["p"] = [ svgEditSymbols.lowercase_p, svgEditSymbols.lowercase_phi, svgEditSymbols.lowercase_pi, svgEditSymbols.lowercase_psi, svgEditSymbols.uppercase_p,  svgEditSymbols.uppercase_phi, svgEditSymbols.uppercase_pi, svgEditSymbols.uppercase_psi];
keyHash["q"] = [ svgEditSymbols.lowercase_q, svgEditSymbols.uppercase_q, svgEditSymbols.symbol_doublestruck_capital_q];
keyHash["r"] = [ svgEditSymbols.lowercase_r, svgEditSymbols.lowercase_rho, svgEditSymbols.uppercase_r, svgEditSymbols.uppercase_rho, svgEditSymbols.symbol_doublestruck_capital_r];
keyHash["s"] = [ svgEditSymbols.lowercase_s, svgEditSymbols.lowercase_sigma, svgEditSymbols.uppercase_s, svgEditSymbols.uppercase_sigma, svgEditSymbols.SUM, svgEditSymbols.SQRT];
keyHash["t"] = [ svgEditSymbols.lowercase_t, svgEditSymbols.lowercase_tau, svgEditSymbols.lowercase_theta, svgEditSymbols.uppercase_t, svgEditSymbols.uppercase_tau, svgEditSymbols.uppercase_theta];
keyHash["u"] = [ svgEditSymbols.lowercase_u, svgEditSymbols.lowercase_upsilon, svgEditSymbols.symbol_nary_union, svgEditSymbols.uppercase_u, svgEditSymbols.uppercase_upsilon];
keyHash["v"] = [ svgEditSymbols.lowercase_v, svgEditSymbols.uppercase_v];
keyHash["w"] = [ svgEditSymbols.lowercase_w, svgEditSymbols.uppercase_w];
keyHash["x"] = [ svgEditSymbols.lowercase_x, svgEditSymbols.lowercase_xi, svgEditSymbols.uppercase_x, svgEditSymbols.uppercase_xi];
keyHash["y"] = [ svgEditSymbols.lowercase_y, svgEditSymbols.uppercase_y];
keyHash["z"] = [ svgEditSymbols.lowercase_z, svgEditSymbols.lowercase_zeta, svgEditSymbols.uppercase_z, svgEditSymbols.uppercase_zeta, svgEditSymbols.symbol_doublestruck_capital_z];

keyHash["&"] = [ svgEditSymbols.symbol_ampersand ];
keyHash["^"] = [ svgEditSymbols.symbol_asciicircum ];
keyHash["~"] = [ svgEditSymbols.symbol_asciitilde];
...
keyHash["|"] = [ svgEditSymbols.symbol_bar];
keyHash["["] = [ svgEditSymbols.symbol_braceleft, svgEditSymbols.symbol_left_square_bracket];
keyHash["]"] = [ svgEditSymbols.symbol_braceright, svgEditSymbols.symbol_right_square_bracket];
...
keyHash["."] = [ svgEditSymbols.symbol_comma, svgEditSymbols.symbol_period, svgEditSymbols.symbol_full_stop, svgEditSymbols.symbol_middle_dot];
keyHash["$"] = [ svgEditSymbols.symbol_dollar];
keyHash["="] = [ svgEditSymbols.symbol_equal, svgEditSymbols.symbol_equals_sign];
