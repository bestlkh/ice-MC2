...
})(
  {
    1: [
      function (e, t, r) {
        (function () {
          ...
          void 0 !== r
            ? (void 0 !== t && t.exports && (r = t.exports = i), (r.EXIF = i))
            : (this.EXIF = i);
          var o = (i.Tags = {
              36864: "ExifVersion",
          ...
          function d(t, n) {
            ...
            if (t.src)
              ...
              var u;
              ((u = new FileReader()).onload = function (t) {
                e &&
                  console.log(
          ...
          function h(e, t, n) {
            for (
              var r, i, o, a, s = new DataView(e), l = {}, u = t;
              u < t + n;

            )
              28 === s.getUint8(u) &&
                2 === s.getUint8(u + 1) &&
                (a = s.getUint8(u + 2)) in g &&
                ((o = s.getInt16(u + 3)) + 5,
                (i = g[a]),
                (r = S(s, u + 5, o)),
                l.hasOwnProperty(i)
          ...
          function p(e, t, n, r, i) {
            ...
            switch (d) {
              ...
              case 10:
                ...
                for (a = [], l = 0; l < f; l++)
                  a[l] =
                    e.getInt32(g + 8 * l, !i) / e.getInt32(g + 4 + 8 * l, !i);
                return a;
            }
          }
          function S(e, t, r) {
          ...
          function P(t, n) {
            if ("Exif" != S(t, n, 4))
              return e && console.log("Not valid EXIF data! " + S(t, n, 4)), !1;
            var r,
              i,
              c,
              d,
              f,
              g = n + 6;
            if (18761 == t.getUint16(g)) r = !1;
            else {
              if (19789 != t.getUint16(g))
                return (
                  e &&
            ...
            if ((i = m(t, g, g + h, a, r)).ExifIFDPointer) {
              d = m(t, g, g + i.ExifIFDPointer, o, r);
              for (c in d) {
                switch (c) {
                  case "LightSource":
                  case "Flash":
            ...
            if (i.GPSInfoIFDPointer) {
              f = m(t, g, g + i.GPSInfoIFDPointer, s, r);
              for (c in f) {
                switch (c) {
                  case "GPSVersionID":
                    f[c] =
            ...
            return (
              (i.thumbnail = (function (e, t, n, r) {
                ...
                if (!u) return {};
                if (u > e.byteLength) return {};
                var c = m(e, t, t + u, l, r);
                if (c.Compression)
                  switch (c.Compression) {
                    case 6:
                      if (c.JpegIFOffset && c.JpegIFByteCount) {
                        var d = t + c.JpegIFOffset,
                          f = c.JpegIFByteCount;
                        c.blob = new Blob([new Uint8Array(e.buffer, d, f)], {
                          type: "image/jpeg",
                        });
                      }
                      break;
    ...
    2: [
      function (e, t, n) {
        ...
        function i(e, t, n) {
          if (null != e) {
            var r = e.height,
              ...
              o = 2;
            null == o && (o = 0),
              "right" == t ? ++o > 3 && (o = 0) : --o < 0 && (o = 3);
            var a = (90 * o * Math.PI) / 180,
              s = n.getContext("2d");
            switch (o) {
              case 0:
                (n.width = i), (n.height = r), s.drawImage(e, 0, 0);
                break;
              case 1:
                (n.width = r),
                  (n.height = i),
        ...
        (t.exports = {
          iOSOrientationAutoFix: function (e, t) {
            var n, o, a;
            (n = e),
              (o = function (n) {
              ...
              (a = null),
              r.getData(n, function () {
                r.getAllTags(this), (a = r.getTag(this, "Orientation")), o(a);
              });
          },
        }),
          (window.ImageUtility = t.exports);
      },
      { "exif-js": 1 },
    ],
  },
