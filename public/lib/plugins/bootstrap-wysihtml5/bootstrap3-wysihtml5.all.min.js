...
(window.rangy = (function () {
      ...
      for (
        a(document, "createRange") &&
          ...
          (c = b(document, "body")
            ...
            a(c, "createTextRange") &&
            ((c = c.createTextRange()), e(c) && (g = !0)),
          !d && !g && f("Neither Range nor TextRange are implemented"),
          s.initialized = !0,
          s.features = { implementsDomRange: d, implementsTextRange: g },
          d = u.concat(t),
          g = 0,
          c = d.length;
        c > g;
  ...
  (s.fail = f),
    (s.warn = function (a) {
      (a = "Rangy warning: " + a),
        s.config.alertOnWarn
          ? window.alert(a)
          : typeof window.console != k &&
            typeof window.console.log != k &&
            window.console.log(a);
    }),
    {}.hasOwnProperty
      ? (s.util.extend = function (a, b) {
  ...
  rangy.createModule("DomUtil", function (a, b) {
    ...
    n.areHostMethods(document, [
      ...
      n.isHostMethod(document, "getElementsByTagName") ||
        b.fail("document missing getElementsByTagName method");
    var o = document.createElement("div");
    n.areHostMethods(o, ["insertBefore", "appendChild", "cloneNode"]) ||
      b.fail("Incomplete Element implementation"),
      n.isHostProperty(o, "innerHTML") ||
  ...
  rangy.createModule("DomRange", function (a) {
    function b(a, b) {
      return (
        3 != a.nodeType &&
        (H.isAncestorOf(a, b.startContainer, !0) ||
          H.isAncestorOf(a, b.endContainer, !0))
      );
    }
    function c(a) {
    ...
    function g(a, b, c) {
      ...
      return (
        H.isCharacterDataNode(b)
          ? c == b.length
            ? H.insertAfter(a, b)
            : b.parentNode.insertBefore(a, 0 == c ? b : H.splitDataNode(b, c))
    ...
    function h(a) {
      for (
        ...
        if (
          ...
          (d = d.cloneNode(!b)),
          b &&
            ((b = a.getSubtreeIterator()), d.appendChild(h(b)), b.detach(!0)),
          10 == d.nodeType)
        )
    ...
    function m(a) {
      return (
        ...
        "(" +
        H.inspectNode(a.startContainer) +
        ":" +
        a.startOffset +
        ", " +
        H.inspectNode(a.endContainer) +
        ":" +
        a.endOffset +
        ")]"
      );
    ...
    function n(a, b) {
      if (
        ...
        this.sc === this.ec && H.isCharacterDataNode(this.sc)
          ? ((this.isSingleCharacterDataNode = !0),
            (this._first = this._last = this._next = this.sc))
          : ((this._first = this._next =
              this.sc !== c || H.isCharacterDataNode(this.sc)
                ? H.getClosestAncestorIn(this.sc, c, !0)
                : this.sc.childNodes[this.so]),
            (this._last =
              this.ec !== c || H.isCharacterDataNode(this.ec)
                ? H.getClosestAncestorIn(this.ec, c, !0)
    ...
    function u(a, b) {
      if (
        0 > b ||
        b > (H.isCharacterDataNode(a) ? a.length : a.childNodes.length)
      )
    ...
    function y(a) {
      if (
        (s(a),
        !(
          (H.arrayContains(L, a.startContainer.nodeType) ||
            P(a.startContainer, !0)) &&
          (H.arrayContains(L, a.endContainer.nodeType) ||
            P(a.endContainer, !0)) &&
          a.startOffset <=
            (H.isCharacterDataNode(a.startContainer)
              ? a.startContainer.length
              : a.startContainer.childNodes.length) &&
          a.endOffset <=
            (H.isCharacterDataNode(a.endContainer)
    ...
    function C(a, b) {
      return function () {
        ...
        return (
          c !== e &&
            ((c = H.getClosestAncestorIn(c, e, !0)),
            (d = f(c)),
            (c = d.node),
            (d = d.offset)),
          i(g, w),
    ...
    function D(c, d, g) {
      ...
      function i(a, b, c) {
        ...
        (b !== a.startContainer || c !== a.startOffset) &&
          ((O(b) != O(e) || 1 == H.comparePoints(b, c, e, f)) &&
            ((e = b), (f = c)),
          d(a, b, c, e, f));
      }
      function l(a, b, c) {
        ...
        a.util.extend(c.prototype, {
          ...
          splitBoundaries: function () {
            ...
            var a = this.startContainer,
              ...
              e = this.endOffset,
              f = a === c;
            H.isCharacterDataNode(c) &&
              e > 0 &&
              e < c.length &&
              H.splitDataNode(c, e),
              H.isCharacterDataNode(a) &&
                b > 0 &&
                b < a.length &&
                ((a = H.splitDataNode(a, b)),
                f
                  ? ((e -= b), (c = a))
                  : c == a.parentNode && e >= H.getNodeIndex(a) && e++,
                (b = 0)),
              d(this, a, b, c, e);
          },
    ...
    function E(a) {
      (a.collapsed =
        ...
        (a.commonAncestorContainer = a.collapsed
          ? a.startContainer
          : H.getCommonAncestor(a.startContainer, a.endContainer));
    }
    function F(a, b, c, e, f) {
      ...
      (a.startContainer = b),
        ...
        (a.endOffset = f),
        E(a),
        d(a, "boundarychange", { startMoved: g, endMoved: h });
    }
    function G(a) {
    ...
    (n.prototype = {
      ...
      remove: function () {
        var a,
          b,
          c = this._current;
        !H.isCharacterDataNode(c) || (c !== this.sc && c !== this.ec)
    ...
    (z.prototype = {
      ...
      insertNode: function (a) {
        if (
          ...
          H.isAncestorOf(a, this.startContainer, !0))
        )
          throw new J("HIERARCHY_REQUEST_ERR");
      ...
      comparePoint: function (a, b) {
        return (
          ...
          0 > H.comparePoints(a, b, this.startContainer, this.startOffset)
            ? -1
            : 0 < H.comparePoints(a, b, this.endContainer, this.endOffset)
            ? 1
            : 0
        );
      },
      createContextualFragment: T
        ? function (a) {
            ...
            return (
              1 == b.nodeType
                ? (d = b)
                : H.isCharacterDataNode(b) && (d = H.parentElement(b)),
              (d =
                null === d ||
                ("HTML" == d.nodeName &&
                  H.isHtmlNamespace(H.getDocument(d).documentElement) &&
                  H.isHtmlNamespace(d))
      ...
      containsNodeContents: function (a) {
        return (
          ...
          0 >= this.comparePoint(a, H.getNodeLength(a))
        );
      },
  ...
  rangy.createModule("WrappedRange", function (a) {
      ...
      if (((j = b.nextSibling), -1 == i && j && e.isCharacterDataNode(j))) {
        if (
          ...
          for (
            ...
            -1 == h.compareEndPoints("StartToEnd", h);
        ...
        (j = (d || !c) && b.previousSibling),
          (h =
            (c = (d || c) && b.nextSibling) && e.isCharacterDataNode(c)
              ? new f(c, 0)
              : j && e.isCharacterDataNode(j)
              ? new f(j, j.length)
              : new f(h, e.getNodeIndex(b)));
    ...
    if (
      ...
      (a.features.implementsTextRange && a.config.preferTextRange)
    ) {
      ...
      (function () {
        ...
        (d = function (a) {
          ...
          g.createPrototypeRange(
            ...
            function (a, b, c, d, e) {
              ...
              (a.startContainer !== b || a.startOffset != c || f) &&
        ...
        (c.setStartBefore = f("setStartBefore", "setEndBefore")),
          ...
          (c.compareBoundaryPoints =
            (-1 == j.compareBoundaryPoints(j.START_TO_END, f)) &
            (1 == j.compareBoundaryPoints(j.END_TO_START, f))
              ? function (a, b) {
                  return (
                    (b = b.nativeRange || b),
                    a == b.START_TO_END
          ...
          a.util.isHostMethod(j, "createContextualFragment") &&
    ...
    a.features.implementsTextRange &&
      (d.rangeToTextRange = function (a) {
        ...
        return (
          a.setEndPoint("StartToStart", b), a.setEndPoint("EndToEnd", d), a
        );
      }),
      ...
      a.addCreateMissingNativeApiListener(function (b) {
        (b = b.document),
          "undefined" == typeof b.createRange &&
            (b.createRange = function () {
  ...
  rangy.createModule("WrappedSelection", function (a, b) {
    ...
    function g(b) {
      ...
      return (
        b instanceof t
          ? ((c = b._selectionNativeRange),
            c ||
              ((c = a.createNativeRange(r.getDocument(b.startContainer))),
          ...
          ? (c = b.nativeRange)
          : a.features.implementsDomRange &&
            b instanceof r.getWindow(b.startContainer).Range &&
            (c = b),
        c
      );
    }
    ...
    function j(b) {
      if (((b._ranges.length = 0), "None" == b.docSelection.type)) f(b);
        ...
        if (c && "undefined" != typeof c.text) i(b, c);
          ...
          for (
            var d, g = r.getDocument(c.item(0)), h = 0;
            h < b.rangeCount;
            ++h
          )
    ...
    function k(a, b) {
      for (
        var c = a.docSelection.createRange(),
          d = h(b),
          e = r.getDocument(c.item(0)),
          e = r.getBody(e).createControlRange(),
          f = 0,
          g = c.length;
        g > f;
        ++f
    ...
    function m(a, b) {
      for (
        var c,
          d = r.getDocument(b[0].startContainer),
          d = r.getBody(d).createControlRange(),
          e = 0;
        rangeCount > e;
        ++e
      ) {
    ...
    z
      ? ((p = d),
        (a.isSelectionValid = function (a) {
          ...
          return (
            "None" != b.type ||
            r.getDocument(b.createRange().parentElement()) == a
          );
        }))
      : x
      ? ((p = c),
    ...
    var x = p(),
      ...
      C = s.areHostObjects(
        x,
        s.areHostProperties(x, ["anchorOffset", "focusOffset"]),
      );
    ...
    var F = !1,
      G = !0;
    s.areHostMethods(x, ["addRange", "getRangeAt", "removeAllRanges"]) &&
      "number" == typeof x.rangeCount &&
      a.features.implementsDomRange &&
      (function () {
    ...
    var H,
      I = !1;
    B &&
      s.isHostMethod(B, "createControlRange") &&
      ((H = B.createControlRange()),
      s.areHostProperties(H, ["item", "add"]) && (I = !0)),
    ...
    if (
        ...
        : C &&
          (J = function (b) {
            ...
            return (
              ...
              c.collapsed !== this.isCollapsed &&
                (c.setStart(b.focusNode, b.focusOffset),
                c.setEnd(b.anchorNode, b.anchorOffset)),
              c
            );
          }),
      (a.getSelection = function (a) {
        ...
        return (
          b
            ? ((b.nativeSelection = c), (b.docSelection = e), b.refresh(a))
            : ((b = new l(c, e, a)), (a._rangySelection = b)),
          b
        );
      }),
      ...
      (H = l.prototype),
      !z && C && s.areHostMethods(x, ["removeAllRanges", "addRange"]))
    ) {
              ...
              F ? (d = this.rangeCount) : (this.removeAllRanges(), (d = 0)),
                ...
                this.rangeCount == d + 1
                  ? (a.config.checkSelectionRanges &&
                      (d = J(this.nativeSelection, this.rangeCount - 1)) &&
                      !t.rangesEqual(d, b) &&
                      (b = new u(d)),
                    (this._ranges[this.rangeCount - 1] = b),
                    e(this, b, N(this.nativeSelection)),
                    (this.isCollapsed = q(this)))
                  : this.refresh();
            }
          }
        : function (a, b) {
      ...
      if (
        !(s.isHostMethod(x, "empty") && s.isHostMethod(A, "select") && I && z)
      )
        return (
    ...
    if (z)
      L = function (b) {
        ...
        a.isSelectionValid(b.win)
          ...
          : ((c = r.getBody(b.win.document).createTextRange()), c.collapse(!0)),
          "Control" == b.docSelection.type
            ? j(b)
            : c && "undefined" != typeof c.text
            ? i(b, c)
            : f(b);
      };
      ...
      if (
        !C ||
        "boolean" != typeof x.isCollapsed ||
        "boolean" != typeof A.collapsed ||
        !a.features.implementsDomRange
      )
        return (
          b.fail(
    ...
    var N;
    !z && C && a.features.implementsDomRange
      ? ((N = function (a) {
          var b = !1;
          return (
            a.anchorNode &&
      ...
      (H.toHtml = function () {
        ...
        if (this.rangeCount) {
          for (
            var a = t.getRangeDocument(this._ranges[0]).createElement("div"),
              b = 0,
      ...
      a.addCreateMissingNativeApiListener(function (b) {
        "undefined" == typeof b.getSelection &&
...
(Base.extend = function (a, b) {
  ...
  (wysihtml5.browser = (function () {
    ...
    return {
      ...
      supportsEvent: function (a) {
        ...
        return (
          (c = "on" + a in b) ||
            (b.setAttribute("on" + a, "return;"),
            (c = "function" == typeof b["on" + a])),
          c
        );
      },
      ...
      supportsDataTransfer: function () {
        try {
          return (
            e && (window.Clipboard || window.DataTransfer).prototype.getData
          );
        } catch (a) {
          return !1;
        }
      ...
      supportsSpeechApiOn: function (b) {
        return (
          11 <= (a.match(/Chrome\/(\d+)/) || [, 0])[1] &&
          ("onwebkitspeechchange" in b || "speech" in b)
        );
      },
  ...
  (wysihtml5.lang.array = function (a) {
    return {
      ...
      without: function (b) {
        for (
          var b = wysihtml5.lang.array(b), c = [], d = 0, e = a.length;
          e > d;
          d++
        )
    ...
    function c(f) {
      if (!d.contains(f.nodeName)) {
        if (f.nodeType !== a.TEXT_NODE || !f.data.match(e)) {
          for (
            h = a.lang.array(f.childNodes).get(), g = h.length, i = 0;
            g > i;
            i++
          )
            c(h[i]);
        ...
        for (
          i || (i = g._wysihtml5_tempElement = g.createElement("div")),
            g = i,
            g.innerHTML = "<span></span>" + b(f.data),
  ...
  (function (a) {
    ...
    (c.addClass = function (a, d) {
      return b
        ? a.classList.add(d)
        : (c.hasClass(a, d) || (a.className += " " + d), void 0);
    }),
      ...
      (c.hasClass = function (a, c) {
        ...
        var d = a.className;
        return (
          0 < d.length && (d == c || RegExp("(^|\\s)" + c + "(\\s|$)").test(d))
        );
      });
  })(wysihtml5),
  ...
  (wysihtml5.dom.convertToList = (function () {
    ...
    return function (b, c) {
      ...
      for (
        k = wysihtml5.lang.array(b.childNodes).get(), l = k.length, h = 0;
        l > h;
        h++
      )
        (g = g || a(i, j)),
          ...
          (f = "BR" === d.nodeName),
          e
            ? ((g = g.firstChild ? a(i, j) : g), g.appendChild(d), (g = null))
            : f
            ? (g = g.firstChild ? null : g)
            : g.appendChild(d);
  ...
  (function (a) {
    var b = [
      ...
      c = function (c) {
        ...
        return d
          ? parseInt(a.getStyle("width").from(c), 10) < c.offsetWidth
          : !1;
      };
  ...
  (wysihtml5.dom.getParentElement = (function () {
    ...
    return function (b, c, d) {
      if (((d = d || 50), c.className || c.classRegExp)) {
        a: {
          for (
            var e = c.nodeName, f = c.className, c = c.classRegExp;
            d-- && b && "BODY" !== b.nodeName;

          ) {
            var g;
            if (
              (g = b.nodeType === wysihtml5.ELEMENT_NODE) &&
              (g = a(b.nodeName, e))
            ) {
              g = f;
        ...
        from: function (d) {
          if (d.nodeType === wysihtml5.ELEMENT_NODE) {
            ...
            if (f.getComputedStyle)
              return (
                e && ((k = g.overflow), (g.overflow = "hidden")),
  ...
  (wysihtml5.dom.hasElementWithTagName = (function () {
    ...
    return function (c, d) {
      var e =
          (c._wysihtml5_identifier || (c._wysihtml5_identifier = b++)) +
          ":" +
          d,
        f = a[e];
  ...
  (function (a) {
    ...
    a.dom.hasElementWithClassName = function (d, e) {
      ...
      var f =
          (d._wysihtml5_identifier || (d._wysihtml5_identifier = c++)) +
          ":" +
          e,
        g = b[f];
  ...
  (wysihtml5.dom.observe = function (a, b, c) {
    for (
      var d, e, b = "string" == typeof b ? [b] : b, f = 0, g = b.length;
      g > f;
      f++
    )
      (e = b[f]),
  ...
  (wysihtml5.dom.parse = (function () {
    ...
    var c = {
        1: function (a) {
          ...
          if ((m && (h = wysihtml5.lang.object(m).clone()), n))
            for (r in n)
              (m = i[n[r]]) &&
                ((m = m(b(a, r))), "string" == typeof m && (h[r] = m));
          if ((k && q.push(k), l))
            for (r in l)
              (m = j[l[r]]) &&
                ((k = m(b(a, r))), "string" == typeof k && q.push(k));
          for (
            o["_wysihtml5-temp-placeholder"] = 1,
              (t = a.getAttribute("class")) && (q = q.concat(t.split(e))),
              l = q.length;
            l > p;
            p++
          )
          ...
          return (
            h.src &&
              ("undefined" != typeof h.width &&
                f.setAttribute("width", h.width),
              "undefined" != typeof h.height &&
    ...
    return function (b, c, d, e) {
      ...
      for (
        var d = d || b.ownerDocument || document,
  ...
  (wysihtml5.dom.removeEmptyTextNodes = function (a) {
    for (
      var b = wysihtml5.lang.array(a.childNodes).get(), c = b.length, d = 0;
      c > d;
      d++
    )
      (a = b[d]),
        a.nodeType === wysihtml5.TEXT_NODE &&
          "" === a.data &&
  ...
  (function (a) {
    ...
    a.resolveList = function (c) {
      if ("MENU" === c.nodeName || "UL" === c.nodeName || "OL" === c.nodeName) {
        ...
        for (
          h && "block" !== a.getStyle("display").from(h) && b(g);
          (f = c.firstChild);
          ...
          for (d = f.lastChild; (h = f.firstChild); )
            (e =
              (e = h === d) &&
              "block" !== a.getStyle("display").from(h) &&
              "BR" !== h.nodeName),
              g.appendChild(h),
              e && b(g);
          f.parentNode.removeChild(f);
    ...
    return {
      on: function (b) {
        if (((b = b.style), "string" == typeof a)) b.cssText += ";" + a;
          ...
          for (var c in a)
            "float" === c
              ? ((b.cssFloat = a[c]), (b.styleFloat = a[c]))
              : (b[c] = a[c]);
      },
    };
  }),
          ...
          b.observe(d.element, "keydown", function (e) {
            if (e.keyCode === a.BACKSPACE_KEY) {
              var f = d.selection.getSelectedNode(),
                e = d.element;
              e.firstChild &&
                a.lang.array(c).contains(e.firstChild.nodeName) &&
                (f = b.getParentElement(f, { nodeName: c })) &&
                f == e.firstChild &&
                1 >= f.childNodes.length &&
    ...
    a.quirks.insertLineBreakOnReturn = function (e) {
      ...
      b.observe(e.element.ownerDocument, "keydown", function (g) {
        ...
        if (!(g.shiftKey || (h !== a.ENTER_KEY && h !== a.BACKSPACE_KEY))) {
          ...
          (i = b.getParentElement(i, { nodeName: c }, 4))
            ? "LI" !== i.nodeName ||
              (h !== a.ENTER_KEY && h !== a.BACKSPACE_KEY)
              ? i.nodeName.match(/H[1-6]/) &&
                h === a.ENTER_KEY &&
                setTimeout(function () {
              ...
              : setTimeout(function () {
                  ...
                  c &&
                    ((a = b.getParentElement(c, { nodeName: d }, 2)) || f(c));
                }, 0)
            : h === a.ENTER_KEY &&
    ...
    a.Selection = Base.extend({
      ...
      selectNode: function (c) {
        ...
        f ? d.selectNodeContents(c) : d.selectNode(c),
          f && g && e
            ? d.collapse(h)
            : f && g && (d.setStartAfter(c), d.setEndAfter(c)),
          this.setSelection(d);
      },
      ...
      scrollIntoView: function () {
        ...
        if (
          ((b = c._wysihtml5ScrollIntoViewElement) ||
            ((b = c.createElement("span")), (b.innerHTML = a.INVISIBLE_SPACE)),
          (b = c._wysihtml5ScrollIntoViewElement = b),
          d)
        ) {
          this.insertNode(b);
          var d = b,
            e = 0;
          if (d.parentNode)
            do (e += d.offsetTop || 0), (d = d.offsetParent);
            while (d);
          (d = e),
            b.parentNode.removeChild(b),
  ...
  (function (a, b) {
    ...
    function d(a, c, e) {
      ...
      if (
        (b.dom.isCharacterDataNode(c) &&
          (0 == e
            ? ((e = b.dom.getNodeIndex(c)), (c = c.parentNode))
            : e == c.length
            ? ((e = b.dom.getNodeIndex(c) + 1), (c = c.parentNode))
    ...
    function e(b) {
      (this.firstTextNode = (this.isElementMerge = b.nodeType == a.ELEMENT_NODE)
        ? b.lastChild
        : b),
      ...
      (f.prototype = {
        ...
        postApply: function (a, b) {
          for (
            ...
            (d = a[n]),
              (f = this.getAdjacentMergeableTextNode(d.parentNode, !1))
                ? (c || ((c = new e(f)), i.push(c)),
                  c.textNodes.push(d),
                  d === g && ((j = c.firstTextNode), (l = j.length)),
                  d === h && ((k = c.firstTextNode), (m = c.getLength())))
                : (c = null);
          if (
            ((g = this.getAdjacentMergeableTextNode(h.parentNode, !0)) &&
              (c || ((c = new e(h)), i.push(c)), c.textNodes.push(g)),
            i.length)
          ) {
        ...
        areElementsMergeable: function (a, c) {
          ...
          if (
            ...
            (d = a.className.replace(h, " ") == c.className.replace(h, " "))
          )
            a: if (a.attributes.length != c.attributes.length) d = !1;
            else {
              d = 0;
              for (var e, f, g = a.attributes.length; g > d; ++d)
                if (
                  ...
                  (f = e.name),
                  "class" != f &&
                    ((f = c.attributes.getNamedItem(f)),
                    e.specified != f.specified ||
                      (e.specified && e.nodeValue !== f.nodeValue)))
                ) {
                  d = !1;
                  break a;
                }
        ...
        isRemovable: function (c) {
          return (
            b.dom.arrayContains(this.tagNames, c.tagName.toLowerCase()) &&
            a.lang.string(c.className).trim() == this.cssClass
          );
        },
          ...
          if (
            (b.containsNode(e) ||
              ...
              a.isPointInRange(b.endContainer, b.endOffset) &&
                c(b.endContainer, b.endOffset) &&
                (d(e, b.endContainer, b.endOffset), b.setEndAfter(e)),
              a.isPointInRange(b.startContainer, b.startOffset) &&
                c(b.startContainer, b.startOffset) &&
                (e = d(e, b.startContainer, b.startOffset))),
            this.similarClassRegExp &&
              e.className &&
        ...
        applyToRange: function (b) {
          ...
          if (
            (b.splitBoundaries(), (c = b.getNodes([a.TEXT_NODE])), c.length)
          ) {
        ...
        undoToRange: function (b) {
          ...
          e.length
            ? (b.splitBoundaries(), (e = b.getNodes([a.TEXT_NODE])))
            : ((e = b.endContainer.ownerDocument.createTextNode(
                a.INVISIBLE_SPACE,
              )),
              b.insertNode(e),
              b.selectNode(e),
          ...
          for (var f = 0, g = e.length; g > f; ++f)
            (c = e[f]),
              (d = this.getAncestorWithClass(c)) &&
                this.undoToTextNode(c, b, d);
          1 == g
            ? this.selectNode(b, e[0])
            : (b.setStart(e[0], 0),
              (c = e[e.length - 1]),
              b.setEnd(c, c.length),
              this.normalize && this.postApply(e, b));
        },
        selectNode: function (b, c) {
          ...
          b.selectNodeContents(c),
            f && d
              ? b.collapse(!1)
              : f && (b.setStartAfter(c), b.setEndAfter(c));
        },
        ...
        isAppliedToRange: function (b) {
          ...
          for (var f, g = 0, h = e.length; h > g; ++g) {
            if (
              ((f = this.getTextSelectedByRange(e[g], b)),
              (c = this.getAncestorWithClass(e[g])),
              "" != f && !c)
            )
              return !1;
            d.push(c);
  ...
  (function (a) {
    function b(b, f) {
      var g,
        ...
        l = 0;
      for (
        a.commands.formatInline.exec(b, c, d, k, /non-matching-class/g),
          g = j.querySelectorAll(d + "." + k),
          k = g.length;
        k > l;
        l++
      )
      ...
      (l = h),
        1 === k &&
          ((i = e.getTextContent(h)),
          (k = !!h.querySelector("*")),
          (i = "" === i || i === a.INVISIBLE_SPACE),
          !k &&
            i &&
            (e.setTextContent(h, f.text || h.href),
            (j = j.createTextNode(" ")),
            b.selection.setAfter(h),
            b.selection.insertNode(j),
            (l = j))),
        ...
        f
          ? a.selection.executeAndRestore(function () {
              for (var a, b, c, d = f.length, g = 0; d > g; g++)
                (a = f[g]),
                  (b = e.getParentElement(a, { nodeName: "code" })),
                  (c = e.getTextContent(a)),
                  c.match(e.autoLink.URL_REG_EXP) && !b
                    ? e.renameElement(a, "code")
                    : e.replaceWithChildNodes(a);
            })
  ...
  (function (a) {
    ...
    a.commands.fontSize = {
      exec: function (c, d, e) {
        return a.commands.formatInline.exec(
          c,
          d,
          "span",
          "wysiwyg-font-size-" + e,
  ...
  (function (a) {
    function b(b) {
      for (
        b = b.previousSibling;
        b && b.nodeType === a.TEXT_NODE && !a.lang.string(b.data).trim();
    ...
    function e(b, c, d, e) {
      if (e)
        var f = g.observe(b, "DOMNodeInserted", function (b) {
          var c,
            b = b.target;
          b.nodeType === a.ELEMENT_NODE &&
            ((c = g.getStyle("display").from(b)),
            "inline" !== c.substr(0, 6) && (b.className += " " + e));
        });
    ...
    a.commands.formatBlock = {
      exec: function (i, j, k, l, m) {
        ...
        if (p)
          i.selection.executeAndRestoreSimple(function () {
            ...
            if (e || p.nodeName !== (k || "DIV"))
              ...
              h && !d(h) && e.parentNode.insertBefore(f.createElement("br"), h),
                i &&
                  !d(i) &&
                  e.parentNode.insertBefore(f.createElement("br"), e),
                g.replaceWithChildNodes(p);
            }
          });
        else {
          if (
            (null === k || a.lang.array(h).contains(k)) &&
            ((n = i.selection.getSelectedNode()),
            (p = g.getParentElement(n, { nodeName: h })))
          )
            return (
              i.selection.executeAndRestoreSimple(function () {
                if ((k && (p = g.renameElement(p, k)), l)) {
                  var a = p;
                  a.className
                    ? ((a.className = a.className.replace(m, "")),
                      (a.className += " " + l))
                    : (a.className = l);
                }
              }),
          ...
          i.commands.support(j)
            ? e(o, j, k || "DIV", l)
            : ((p = o.createElement(k || "DIV")),
              l && (p.className = l),
              f(i, p));
        }
      },
      state: function (a, b, c, d, e) {
        return (
          ...
          g.getParentElement(a, { nodeName: c, className: d, classRegExp: e })
        );
      },
      value: function () {},
    };
  ...
  (function (a) {
    ...
    var c = { strong: "b", em: "i", b: "strong", i: "em" },
      d = {};
    a.commands.formatInline = {
      exec: function (a, c, d, e, f) {
        return (c = a.selection.getRange())
          ? (b(d, e, f).toggleRange(c), a.selection.setSelection(c), void 0)
          : !1;
      },
      state: function (d, e, f, g, h) {
        var e = d.doc,
          i = c[f] || f;
        return (!a.dom.hasElementWithTagName(e, f) &&
          !a.dom.hasElementWithTagName(e, i)) ||
          (g && !a.dom.hasElementWithClassName(e, g))
          ? !1
          : ((d = d.selection.getRange()),
            d ? b(f, g, h).isAppliedToRange(d) : !1);
      },
      value: function () {},
    };
  })(wysihtml5),
    ...
    a.commands.insertImage = {
      exec: function (b, c, d) {
        var e,
          ...
          c = this.state(b);
        if (c)
          b.selection.setBefore(c),
            (d = c.parentNode),
            d.removeChild(c),
            a.dom.removeEmptyTextNodes(d),
            "A" === d.nodeName &&
              !d.firstChild &&
              (b.selection.setAfter(d), d.parentNode.removeChild(d)),
          ...
          b.selection.insertNode(c),
            a.browser.hasProblemsSettingCaretAfterImg()
              ? ((d = f.createTextNode(a.INVISIBLE_SPACE)),
                b.selection.insertNode(d),
                b.selection.setAfter(d))
              : b.selection.setAfter(c);
        }
      },
      state: function (b) {
        var c;
        return a.dom.hasElementWithTagName(b.doc, "IMG")
          ? (c = b.selection.getSelectedNode())
            ? "IMG" === c.nodeName
              ? c
              : c.nodeType !== a.ELEMENT_NODE
              ? !1
              : ((c = b.selection.getText()),
                (c = a.lang.string(c).trim())
                  ? !1
                  : ((b = b.selection.getNodes(a.ELEMENT_NODE, function (a) {
    ...
    a.commands.insertOrderedList = {
      exec: function (b, c) {
        var d,
          ...
          g = a.dom.getParentElement(f, { nodeName: "OL" }),
          h = a.dom.getParentElement(f, { nodeName: "UL" }),
          f = "_wysihtml5-temp-" + new Date().getTime();
        b.commands.support(c)
          ...
          : (b.commands.exec("formatBlock", "div", f),
            (d = e.querySelector("." + f)),
            (e = "" === d.innerHTML || d.innerHTML === a.INVISIBLE_SPACE),
            b.selection.executeAndRestoreSimple(function () {
      ...
      state: function (b) {
        return (
          ...
          a.dom.getParentElement(b, { nodeName: "OL" })
        );
      },
      value: function () {},
    };
    ...
    a.commands.insertUnorderedList = {
      exec: function (b, c) {
        var d,
          e = b.doc,
          f = b.selection.getSelectedNode(),
          g = a.dom.getParentElement(f, { nodeName: "UL" }),
          h = a.dom.getParentElement(f, { nodeName: "OL" }),
          f = "_wysihtml5-temp-" + new Date().getTime();
        b.commands.support(c)
          ? e.execCommand(c, !1, null)
          : g
      ...
      state: function (b) {
        return (
          (b = b.selection.getSelectedNode()),
          a.dom.getParentElement(b, { nodeName: "UL" })
        );
      },
      value: function () {},
    };
  ...
  (function (a) {
    ...
    a.UndoManager = a.lang.Dispatcher.extend({
          ...
          d.observe(this.element, "contextmenu", function () {
            j(),
              f.composer.selection.executeAndRestoreSimple(function () {
                f.element.lastChild &&
                  f.composer.selection.setAfter(f.element.lastChild),
                  g.execCommand("insertHTML", !1, b),
                  g.execCommand("insertHTML", !1, c),
                  g.execCommand("undo", !1, null);
              }),
              (h = setInterval(function () {
                g.getElementById("_wysihtml5-redo")
                  ? (j(), f.redo())
                  : g.getElementById("_wysihtml5-undo") || (j(), f.undo());
              }, 400)),
              i ||
                ((i = !0),
                d.observe(document, "mousedown", j),
                d.observe(g, ["mousedown", "paste", "cut", "copy"], j));
          });
        }
        this.editor
      ...
      transact: function () {
        ...
        b != a &&
          (40 < (this.history.length = this.position) &&
        ...
        e && (b.addClass(this.element, e), b.addClass(this.iframe, e)),
          (e =
            "string" == typeof this.config.placeholder
              ...
              : this.textarea.element.getAttribute("placeholder")) &&
            b.simulatePlaceholder(this.parent, this, e),
          ...
          c.clearsListsInContentEditableCorrectly() ||
            a.quirks.ensureProperClearingOfLists(this),
      ...
      _initAutoLinking: function () {
        ...
        if (
          ...
          var g = this.sandbox.getDocument().getElementsByTagName("a"),
            ...
            i = function (c) {
              return (
                (c = a.lang.string(b.getTextContent(c)).trim()),
          ...
          b.observe(this.element, "keydown", function (a) {
            if (g.length) {
              var c,
                ...
                e = b.getParentElement(a, { nodeName: "A" }, 4);
              e &&
                ((c = i(e)),
                setTimeout(function () {
                  var a = i(e);
          ...
          this.config.allowObjectResizing
            ? c.supportsEvent("resizeend") &&
              b.observe(f, "resizeend", function (b) {
                for (
                  var c, b = b.target || b.srcElement, g = b.style, h = 0;
                  e > h;
                  h++
                )
                  (c = d[h]),
                    g[c] &&
                      (b.setAttribute(c, parseInt(g[c], 10)), (g[c] = ""));
                a.quirks.redraw(f);
              })
            : c.supportsEvent("resizestart") &&
              b.observe(f, "resizestart", function (a) {
                a.preventDefault();
              });
      },
  ...
  (function (a) {
    ...
    a.views.Composer.prototype.style = function () {
      ...
      if (
        ...
        !a.browser.hasCurrentStyleProperty())
      )
          ...
          if (b.contains(document.documentElement, k.iframe)) {
            ...
            (m.style.display = ""),
              ...
              b
                ...
                .from(m)
                .to(k.iframe)
                .andTo(k.focusStylesHost)
                .andTo(k.blurStylesHost),
  ...
  (function (a) {
    ...
    a.views.Composer.prototype.observe = function () {
      ...
      var k = setInterval(function () {
        b.contains(document.documentElement, g) ||
          (clearInterval(k), e.parent.fire("destroy:composer"));
      }, 250);
      b.observe(i, "focus", function () {
        ...
        c.firesOnDropOnlyWhenOnDragOverIsCancelled() &&
          b.observe(h, ["dragover", "dragenter"], function (a) {
            a.preventDefault();
          }),
        b.observe(h, j, function (a) {
          var b,
            d = a.dataTransfer;
          d &&
            c.supportsDataTransfer() &&
            (b = d.getData("text/html") || d.getData("text/plain")),
            b
              ? (h.focus(),
                e.commands.exec("insertHTML", b),
        ...
        c.canSelectImagesInContentEditable() ||
          b.observe(h, "mousedown", function (a) {
            var b = a.target;
            "IMG" === b.nodeName &&
              (e.selection.selectNode(b), a.preventDefault());
          }),
      ...
      b.observe(h, "mouseover", function (a) {
        ...
        !("A" !== b && "IMG" !== b) &&
          ...
          ((b = l[b] + (a.getAttribute("href") || a.getAttribute("src"))),
  ...
  (function (a) {
    a.views.Synchronizer = Base.extend({
      ...
      _observe: function () {
        ...
        e(),
          d &&
            (a.dom.observe(d, "submit", function () {
              c.sync(!0);
            }),
          ...
          this.editor.observe("change_view", function (a) {
            "composer" !== a || b
              ? "textarea" === a && (c.fromComposerToTextarea(!0), f())
              : (c.fromTextareaToComposer(!0), e());
          }),
    ...
    a.toolbar.Dialog = a.lang.Dispatcher.extend({
      ...
      _observe: function () {
        if (!this._observed) {
          ...
          b.observe(c.link, "click", function () {
            b.hasClass(c.link, "wysihtml5-command-dialog-opened") &&
              setTimeout(function () {
                c.hide();
              }, 0);
          }),
      ...
      _interpolate: function (a) {
        for (
          var b,
            c,
            d = document.querySelector(":focus"),
      ...
      show: function (a) {
        ...
        if (
          ...
          b.addClass(this.link, "wysihtml5-command-dialog-opened"),
    ...
    a.toolbar.Toolbar = Base.extend({
      constructor: function (b, c) {
        (this.editor = b),
          ...
          this.show();
        for (
          var d = this.container.querySelectorAll(
      ...
      _getDialog: function (b, c) {
        ...
        return (
          g &&
            ((d = new a.toolbar.Dialog(b, g)),
            d.observe("show", function () {
      ...
      _observe: function () {
        for (
          ...
          b.setAttributes({ href: "javascript:;", unselectable: "on" }).on(
            e[g],
          );
          ...
          c.observe("change_view", function (c) {
            setTimeout(function () {
              (a.commandsDisabled = "composer" !== c),
                a._updateLinkStates(),
                a.commandsDisabled
                  ? b.addClass(d, "wysihtml5-commands-disabled")
        ...
        for (c in f)
          (e = f[c]),
            this.commandsDisabled
              ? ((d = !1),
                b.removeClass(e.link, "wysihtml5-command-active"),
                e.group && b.removeClass(e.group, "wysihtml5-command-active"),
                e.dialog && e.dialog.hide())
              : ((d = this.composer.commands.state(e.name, e.value)),
                a.lang.object(d).isArray() && (d = 1 === d.length ? d[0] : !0),
                b.removeClass(e.link, "wysihtml5-command-disabled"),
                e.group &&
                  b.removeClass(e.group, "wysihtml5-command-disabled")),
            e.state !== d &&
              ((e.state = d)
                ? (b.addClass(e.link, "wysihtml5-command-active"),
                  e.group && b.addClass(e.group, "wysihtml5-command-active"),
                  e.dialog &&
                    ("object" == typeof d ? e.dialog.show(d) : e.dialog.hide()))
                : (b.removeClass(e.link, "wysihtml5-command-active"),
                  e.group && b.removeClass(e.group, "wysihtml5-command-active"),
                  e.dialog && e.dialog.hide()));
        for (c in g)
          (f = g[c]),
            "change_view" === f.name &&
              ((f.state = this.editor.currentView === this.editor.textarea),
              f.state
                ? b.addClass(f.link, "wysihtml5-action-active")
                : b.removeClass(f.link, "wysihtml5-action-active"));
      },
      show: function () {
        this.container.style.display = "";
      },
      ...
      constructor: function (c, d) {
        if (
          ((this.textareaElement =
            "string" == typeof c ? document.getElementById(c) : c),
          (this.config = a.lang.object({}).merge(b).merge(d).get()),
          (this.currentView = this.textarea =
            new a.views.Textarea(this, this.textareaElement, this.config)),
          ...
          a.dom.addClass(document.body, this.config.bodyClassName),
            (this.currentView = this.composer =
              new a.views.Composer(this, this.textareaElement, this.config)),
...
var Handlebars = (function () {
    var a = (function () {
      ...
      c = (function () {
        ...
        function a() {
          for (
            var a = Error.prototype.constructor.apply(this, arguments), b = 0;
            b < c.length;
            b++
          )
            this[c[b]] = a[c[b]];
        ...
        function e(a, b) {
          ...
          c = b.compile
            ? function (a, c, d, e, f, g) {
                ...
                return (
                  (f[c] = b.compile(a, { data: void 0 !== g }, b)), f[c](d, j)
                );
              }
            : function (a, b) {
...
(this.wysihtml5 = this.wysihtml5 || {}),
  ...
  (this.wysihtml5.tpl.emphasis = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (i +=
        ...
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.emphasis),
          (g = null == g || g === !1 ? g : g.bold),
          typeof g === j ? g.apply(b) : g),
        ) +
        '</a>\n    <a class="btn '),
      (h = c["if"].call(
    ...
    function (a, b, c, d, e) {
      ...
      return (
        ...
        (i +=
          ...
          k(
            ((g = b && b.locale),
            (g = null == g || g === !1 ? g : g.font_styles),
            (g = null == g || g === !1 ? g : g.normal),
            typeof g === j ? g.apply(b) : g),
          ) +
  ...
  (this.wysihtml5.tpl.html = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (i +=
        ...
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.html),
          (g = null == g || g === !1 ? g : g.edit),
          typeof g === j ? g.apply(b) : g),
        ) +
  ...
  (this.wysihtml5.tpl.image = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      (i +=
        ...
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.image),
          (g = null == g || g === !1 ? g : g.insert),
          typeof g === j ? g.apply(b) : g),
        ) +
  ...
  (this.wysihtml5.tpl.link = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      (i +=
        ...
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.link),
          (g = null == g || g === !1 ? g : g.insert),
          typeof g === j ? g.apply(b) : g),
        ) +
        '</h3>\n        </div>\n        <div class="modal-body">\n          <input value="http://" class="bootstrap-wysihtml5-insert-link-url form-control">\n          <div class="checkbox"><label> <input type="checkbox" class="bootstrap-wysihtml5-insert-link-target" checked>' +
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.link),
          (g = null == g || g === !1 ? g : g.target),
          typeof g === j ? g.apply(b) : g),
        ) +
        '</label></div>\n        </div>\n        <div class="modal-footer">\n          <a class="btn btn-default" data-dismiss="modal">' +
        k(
  ...
  (this.wysihtml5.tpl.lists = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (i +=
        ...
        k(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.lists),
          (g = null == g || g === !1 ? g : g.unordered),
          typeof g === j ? g.apply(b) : g),
        ) +
  ...
  "object" == typeof exports &&
    exports &&
    (module.exports = this.wysihtml5.tpl),
  !(function (a, b) {
    "use strict";
    var c = function (a, c, d) {
      ...
      d = function (c, d) {
        ...
        (this.toolbar = this.createToolbar(c, e)),
          (this.editor = this.createEditor(d)),
    ...
    d.prototype = {
      ...
      createToolbar: function (b, d) {
        ...
        for (var j in f) {
          var k = !1;
          void 0 !== d[j] ? d[j] === !0 && (k = !0) : (k = f[j]),
            k === !0 &&
              (h.append(c(j, g[i], d)),
              "html" === j && this.initHtml(h),
              "link" === j && this.initInsertLink(h),
              "image" === j && this.initInsertImage(h));
        }
