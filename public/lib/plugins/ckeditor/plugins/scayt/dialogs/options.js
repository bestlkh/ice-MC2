...
CKEDITOR.dialog.add("scaytcheck", function (j) {
  ...
  function n(a) {
    f.getById("dic_message_" + b).setHtml(
  ...
  var s = !0,
    ...
    u = 0,
    m = [
      "dic_create_" + b + ",dic_restore_" + b,
      "dic_rename_" + b + ",dic_delete_" + b,
    ],
  ...
  var A = function () {
      ...
      for (e = i.length; c < e; c += 1)
        if ((d = f.getById(i[c]))) d.on("click", a, this);
    },
    y = function () {
      var a = this;
      if (1 == l[0])
        for (var g = w(), e = 0, d = g.length; e < d; e++) {
          ...
          if (
            i &&
            ((g[e].checked = !1),
            1 == a.options[h.split("_")[0]] && (g[e].checked = !0),
            s)
          )
            i.on("click", function () {
