    ...
    (e.hu = function () {
      ...
      (e.hu.stemmer =
        ...
        (i = new (function () {
          ...
          function h() {
            var e = d.limit - d.cursor;
            return !!d.find_among_b(t, 23) && ((d.cursor = d.limit - e), !0);
          }
          function p() {
            if (d.cursor > d.limit_backward) {
              d.cursor--, (d.ket = d.cursor);
              var e = d.cursor - 1;
              d.limit_backward <= e &&
                e <= d.limit &&
                ((d.cursor = e), (d.bra = e), d.slice_del());
            }
          }
          function _() {
            (d.ket = d.cursor),
              d.find_among_b(c, 44) &&
                ...
                g() &&
                  ...
                  (function () {
                    ...
                    if (
                      ((d.ket = d.cursor),
                      (e = d.find_among_b(a, 2)) && ((d.bra = d.cursor), g()))
                    )
                      switch (e) {
                        case 1:
                          d.slice_from("a");
            ...
            (this.stem = function () {
              ...
              return (
                (function () {
                  var n,
                    r = d.cursor;
                  if (((e = d.limit), d.in_grouping(b, 97, 252)))
                    for (;;) {
                      if (((n = d.cursor), d.out_grouping(b, 97, 252)))
                        return (
                          (d.cursor = n),
                          d.find_among(i, 8) ||
                            ((d.cursor = n), n < d.limit && d.cursor++),
                          void (e = d.cursor)
                        );
                      if (((d.cursor = n), n >= d.limit)) return void (e = n);
                      d.cursor++;
                    }
                  if (((d.cursor = r), d.out_grouping(b, 97, 252))) {
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(s, 2)) && ((d.bra = d.cursor), g()))
                  ) {
                    if ((1 == e || 2 == e) && !h()) return;
                    d.slice_del(), p();
                  }
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(w, 3)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                        d.slice_from("e");
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(o, 6)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                      case 2:
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(l, 2)) && ((d.bra = d.cursor), g()))
                  ) {
                    if ((1 == e || 2 == e) && !h()) return;
                    d.slice_del(), p();
                  }
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(m, 12)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                      case 4:
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(k, 31)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                      case 4:
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(f, 42)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                      case 4:
                ...
                (function () {
                  ...
                  if (
                    ((d.ket = d.cursor),
                    (e = d.find_among_b(u, 7)) && ((d.bra = d.cursor), g()))
                  )
                    switch (e) {
                      case 1:
                        d.slice_from("a");
