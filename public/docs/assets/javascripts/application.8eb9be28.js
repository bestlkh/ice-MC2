  ...
  (function (e) {
              ...
              (function e(t) {
                Array.prototype.forEach.call(t, function (t) {
                  "string" == typeof t || "number" == typeof t
                    ...
                    ? e(t)
                    : void 0 !== t.__html
                    ? (n.innerHTML += t.__html)
                    : t instanceof Node && n.appendChild(t);
                });
              })(i),
              n
            );
                  ...
                  function i() {
                    ...
                    return (
                      o
                        ...
                        .replace(/^(.*?):\s*([\s\S]*?)$/gm, function (i, o, a) {
                          t.push((o = o.toLowerCase())),
                            n.push([o, a]),
                            (e = r[o]),
                            (r[o] = e ? e + "," + a : a);
                        }),
      ...
      var i = (function () {
        function e(t, n, i) {
          ...
          r(this, e),
            ...
            (this.handler_ = "function" == typeof i ? { update: i } : i),
        ...
        function i(t) {
          new f.default.Event.Listener(
            ...
            function () {
              ...
              if (
                ...
                new c.default(".md-clipboard").on("success", function (e) {
                  ...
                  e.clearSelection(),
                    ...
                    (t.innerHTML = h("clipboard.copied")),
              ...
              if (
                (window.addEventListener("hashchange", i), i(), Modernizr.ios)
              ) {
                ...
                Array.prototype.forEach.call(o, function (e) {
                  e.addEventListener("touchstart", function () {
                    ...
                    0 === t
                      ? (e.scrollTop = 1)
                      : t + e.offsetHeight === e.scrollHeight &&
                        (e.scrollTop = t - 1);
                  });
                });
              }
            ...
            document.querySelector("[data-md-component=hero]") &&
              new f.default.Event.Listener(
                window,
                ["scroll", "resize", "orientationchange"],
                new f.default.Tabs.Toggle("[data-md-component=hero]"),
              ).listen(),
            document.querySelector("[data-md-component=tabs]") &&
              new f.default.Event.Listener(
                window,
                ["scroll", "resize", "orientationchange"],
                new f.default.Tabs.Toggle("[data-md-component=tabs]"),
              ).listen(),
            new f.default.Event.MatchMedia(
              "(min-width: 1220px)",
              new f.default.Event.Listener(
                window,
                ["scroll", "resize", "orientationchange"],
                new f.default.Sidebar.Position(
            ...
            new f.default.Event.MatchMedia(
              ...
              new f.default.Event.Listener(
                window,
                "scroll",
                new f.default.Nav.Blur("[data-md-component=toc] [href]"),
              ),
            );
          ...
          Array.prototype.forEach.call(n, function (e) {
            ...
            new f.default.Event.MatchMedia(
              ...
              new f.default.Event.Listener(
                ...
                "change",
                new f.default.Nav.Scrolling(
                  "[data-md-component=navigation] nav",
                ),
              ),
            ),
            document.querySelector("[data-md-component=search]") &&
              (new f.default.Event.MatchMedia(
                ...
                new f.default.Event.Listener(
                  ...
                  "change",
                  new f.default.Search.Lock("[data-md-toggle=search]"),
                ),
              ),
              new f.default.Event.Listener(
                "[data-md-component=query]",
                ["focus", "keyup", "change"],
                new f.default.Search.Result(
                  "[data-md-component=result]",
                  function () {
                    return fetch(
                      t.url.base +
                        "/" +
                        (t.version < "0.17" ? "mkdocs" : "search") +
                        "/search_index.json",
              ...
              new f.default.Event.Listener(window, "keypress", function () {
                var e = document.querySelector("[data-md-toggle=search]");
                if (!(e instanceof HTMLInputElement))
                  throw new ReferenceError();
                if (e.checked) {
            ...
            new f.default.Event.Listener(document.body, "keydown", function (
              e,
            ) {
              if (9 === e.keyCode) {
        ...
        function o(e, t) {
          ...
          (e._handled = !0),
            i._immediateFn(function () {
              ...
              if (null === n)
                return void (1 === e._state ? a : s)(t.promise, e._value);
              var r;
              try {
                r = n(e._value);
              } catch (e) {
    ...
    function (e, t) {
      ...
      function a() {
        m &&
          h &&
          ((m = !1), h.length ? (p = h.concat(p)) : (v = -1), p.length && s());
      }
      function s() {
        if (!m) {
          var e = i(a);
        ...
        (i.prototype.needsClick = function (e) {
          ...
          (i.prototype.onTouchEnd = function (e) {
            ...
            return (
              ...
              (this.needsClick(l) || (e.preventDefault(), this.sendClick(l, e)),
              !1)
            );
          }),
    ...
    function (e, t, n) {
      ...
      var i = (function () {
        function e(t, n) {
          ...
          if (
            !(i instanceof HTMLElement && i.parentNode instanceof HTMLElement)
          )
            throw new ReferenceError();
          if (
            ((this.el_ = i.parentNode),
            !(
              (i =
                "string" == typeof n ? document.querySelector(n) : n) instanceof
              HTMLElement
            ))
          )
            throw new ReferenceError();
      ...
      var i = (function () {
        ...
        return (
          ...
          (e.prototype.update = function (e) {
            ...
            n !== this.active_ &&
              (this.el_.dataset.mdState = (this.active_ = n) ? "active" : ""),
        ...
        function e(t) {
          r(this, e),
            ...
            (this.anchors_ = [].reduce.call(
              ...
              function (e, t) {
                return e.concat(
                  document.getElementById(t.hash.substring(1)) || [],
                );
              },
              [],
            ));
        ...
        var o = n(40),
          ...
          d = (function () {
            function t(e, n) {
              ...
              u.length && (c.default.tokenizer.separator = u),
                (this.lang_ = l("search.language")
                  .split(",")
                  .filter(Boolean)
                  .map(function (e) {
                    return e.trim();
              ...
              (t.prototype.update = function (t) {
                ...
                if ("focus" !== t.type || this.index_) {
                  if ("focus" === t.type || "keyup" === t.type) {
                    ...
                    if (((this.value_ = r.value), 0 === this.value_.length))
                    ...
                    var i = this.index_
                      ...
                      o = (0, a.default)(this.value_.trim()).replace(
                        new RegExp(c.default.tokenizer.separator, "img"),
                        "|",
                      ),
                      s = new RegExp(
                        "(^|" + c.default.tokenizer.separator + ")(" + o + ")",
                        "img",
                      ),
                      d = function (e, t, n) {
                        return t + "<em>" + n + "</em>";
                    ...
                    for (
                      ;
                      this.stack_.length &&
                      f.offsetHeight >= f.scrollHeight - 16;
                  ...
                  var p = function (e) {
                    ...
                    var t = n.docs_,
                      r = n.lang_;
                    (n.stack_ = []),
                      (n.index_ = (0, c.default)(function () {
                        var e,
                          n = this,
                          i = {
                            "search.pipeline.trimmer": c.default.trimmer,
                            "search.pipeline.stopwords":
                              c.default.stopWordFilter,
                          },
                          o = Object.keys(i).reduce(function (e, t) {
                            return l(t).match(/^false$/i) || e.push(i[t]), e;
                          }, []);
                        this.pipeline.reset(),
                          o && (e = this.pipeline).add.apply(e, o),
                          1 === r.length && "en" !== r[0] && c.default[r[0]]
                            ? this.use(c.default[r[0]])
                            : r.length > 1 &&
                              this.use(
                                c.default.multiLanguage.apply(c.default, r),
                              ),
                    ...
                    i.addEventListener("scroll", function () {
                      for (
                        ;
                        n.stack_.length &&
                        i.scrollTop + i.offsetHeight >= i.scrollHeight - 16;
                  ...
                  setTimeout(function () {
                    return "function" == typeof n.data_
                      ? n.data_().then(p)
                      : p(n.data_);
                  }, 250);
                }
    ...
    function (e, t, n) {
      ...
      !(function () {
        var o = function (e) {
          var t = new o.Builder();
          return (
            t.pipeline.add(o.trimmer, o.stopWordFilter, o.stemmer),
            t.searchPipeline.add(o.stemmer),
            e.call(t, t),
            t.build()
          );
        };
        (o.version = "2.1.5"),
          (o.utils = {}),
          (o.utils.warn = (function (e) {
            return function (t) {
              e.console && console.warn && console.warn(t);
            };
          })(this)),
          (o.utils.asString = function (e) {
          ...
          (o.FieldRef.joiner = "/"),
          (o.FieldRef.fromString = function (e) {
          ...
          (o.FieldRef.prototype.toString = function () {
            return (
              void 0 == this._stringValue &&
                (this._stringValue =
                  this.fieldName + o.FieldRef.joiner + this.docRef),
              this._stringValue
            );
          }),
          (o.idf = function (e, t) {
          ...
          (o.tokenizer = function (e) {
            ...
            for (
              ...
              var s = t.charAt(i),
                c = i - a;
              (s.match(o.tokenizer.separator) || i == n) &&
                (c > 0 &&
                  r.push(
                    new o.Token(t.slice(a, i), {
                      position: [a, c],
                      index: r.length,
                    }),
                  ),
          ...
          (o.tokenizer.separator = /[\s\-]+/),
          (o.Pipeline = function () {
            this._stack = [];
          }),
          (o.Pipeline.registeredFunctions = Object.create(null)),
          (o.Pipeline.registerFunction = function (e, t) {
            t in this.registeredFunctions &&
              o.utils.warn("Overwriting existing registered function: " + t),
              (e.label = t),
              (o.Pipeline.registeredFunctions[e.label] = e);
          }),
          ...
          (o.stemmer = (function () {
            var e = {
              ...
              k = function (n) {
                ...
                if (
                  ((T = n.substr(0, 1)),
                  "y" == T && (n = T.toUpperCase() + n.substr(1)),
                  (S = c),
                  (L = u),
                  S.test(n)
                    ? (n = n.replace(S, "$1$2"))
                    : L.test(n) && (n = n.replace(L, "$1$2")),
                  (S = l),
                  (L = d),
                  S.test(n))
                ) {
                ...
                if (((S = E), S.test(n))) {
                  ...
                  (r = O[1]),
                    ...
                    (L = a),
                    (C = b),
                    (S.test(r) || (L.test(r) && !C.test(r))) && (n = r);
                }
                return (
                  (S = x),
                  (L = o),
                  S.test(n) && L.test(n) && ((S = f), (n = n.replace(S, ""))),
                  "y" == T && (n = T.toLowerCase() + n.substr(1)),
                  n
                );
              };
            return function (e) {
          ...
          (o.stopWordFilter = o.generateStopWordFilter([
            "a",
            "able",
            "about",
            "across",
          ...
          (o.TokenSet = function () {
            (this.final = !1),
              (this.edges = {}),
              (this.id = o.TokenSet._nextId),
              (o.TokenSet._nextId += 1);
          }),
          (o.TokenSet._nextId = 1),
          (o.TokenSet.fromArray = function (e) {
            for (
              var t = new o.TokenSet.Builder(), n = 0, r = e.length;
              n < r;
              n++
            )
              t.insert(e[n]);
          ...
          (o.TokenSet.fromClause = function (e) {
            return "editDistance" in e
              ? o.TokenSet.fromFuzzyString(e.term, e.editDistance)
              : o.TokenSet.fromString(e.term);
          }),
          (o.TokenSet.fromFuzzyString = function (e, t) {
            for (
              var n = new o.TokenSet(),
              ...
              if (i.str.length > 0) {
                ...
                s in i.node.edges
                  ? (a = i.node.edges[s])
                  : ((a = new o.TokenSet()), (i.node.edges[s] = a)),
                  1 == i.str.length
                    ? (a.final = !0)
                    : r.push({
                        node: a,
              ...
              if (i.editsRemaining > 0 && i.str.length > 1) {
                ...
                s in i.node.edges
                  ? (c = i.node.edges[s])
                  : ((c = new o.TokenSet()), (i.node.edges[s] = c)),
                  i.str.length <= 2
                    ? (c.final = !0)
                    : r.push({
                        node: c,
              ...
              if (
                (i.editsRemaining > 0 &&
                  1 == i.str.length &&
                  (i.node.final = !0),
                i.editsRemaining > 0 && i.str.length >= 1)
              ) {
              ...
              if (i.editsRemaining > 0 && i.str.length > 1) {
                ...
                h in i.node.edges
                  ? (d = i.node.edges[h])
                  : ((d = new o.TokenSet()), (i.node.edges[h] = d)),
                  1 == i.str.length
                    ? (d.final = !0)
                    : r.push({
                        node: d,
          ...
          (o.TokenSet.fromString = function (e) {
            for (
              var t = new o.TokenSet(), n = t, r = !1, i = 0, a = e.length;
              i < a;
              i++
            ) {
              var s = e[i],
                ...
                for (var l = i[u], d = 0; d < c; d++) {
                  ...
                  if (f == l || "*" == l) {
                    var h = n.node.edges[f],
                      ...
                      v = void 0;
                    f in n.output.edges
                      ? ((v = n.output.edges[f]), (v.final = v.final || m))
                      : ((v = new o.TokenSet()),
                        (v.final = m),
                        (n.output.edges[f] = v)),
                      r.push({ qNode: p, output: v, node: h });
                  }
                }
            }
            return t;
          ...
          (o.TokenSet.Builder.prototype.insert = function (e) {
            ...
            for (var r = n; r < e.length; r++) {
              var i = new o.TokenSet(),
                a = e[r];
              (t.edges[a] = i),
                this.uncheckedNodes.push({ parent: t, char: a, child: i }),
                (t = i);
            }
          ...
          (o.Index.prototype.query = function (e) {
                ...
                for (
                  ...
                  for (
                    ...
                    var g = s.fields[y],
                      ...
                      E = p + "/" + g;
                    if (
                      (void 0 === r[g] && (r[g] = new o.Vector()),
                      r[g].upsert(v, 1 * s.boost, function (e, t) {
                        return e + t;
                      }),
                      !i[E])
                    ) {
            ...
            for (
              var L = Object.keys(n), C = [], M = Object.create(null), a = 0;
              a < L.length;
              a++
            ) {
              var O,
                A = o.FieldRef.fromString(L[a]),
                R = A.docRef,
                I = this.fieldVectors[A],
                P = r[A.fieldName].similarity(I);
              if (void 0 !== (O = M[R]))
                (O.score += P), O.matchData.combine(n[A]);
              else {
          ...
          (o.Builder.prototype.add = function (e) {
            ...
            for (var n = 0; n < this._fields.length; n++) {
              ...
              (this.fieldTermFrequencies[c] = u),
                (this.fieldLengths[c] = 0),
                (this.fieldLengths[c] += s.length);
              for (var l = 0; l < s.length; l++) {
                var d = s[l];
                if (
                  (void 0 == u[d] && (u[d] = 0),
                  (u[d] += 1),
                  void 0 == this.invertedIndex[d])
                ) {
                ...
                void 0 == this.invertedIndex[d][r][t] &&
                  (this.invertedIndex[d][r][t] = Object.create(null));
                for (var p = 0; p < this.metadataWhitelist.length; p++) {
                  var m = this.metadataWhitelist[p],
                    v = d.metadata[m];
                  void 0 == this.invertedIndex[d][r][t][m] &&
                    (this.invertedIndex[d][r][t][m] = []),
                    this.invertedIndex[d][r][t][m].push(v);
                }
              }
            }
          }),
          ...
          (o.Builder.prototype.createFieldVectors = function () {
            for (
              ...
              for (
                var a = o.FieldRef.fromString(t[i]),
                  s = a.fieldName,
                  c = this.fieldLengths[a],
                  u = new o.Vector(),
                  l = this.fieldTermFrequencies[a],
                  d = Object.keys(l),
                  f = d.length,
                  h = 0;
                h < f;
                ...
                void 0 === r[y]
                  ? ((p = o.idf(this.invertedIndex[y], this.documentCount)),
                    (r[y] = p))
                  : (p = r[y]),
                  (m =
                    (p * ((this._k1 + 1) * g)) /
                    (this._k1 *
                      (1 -
                        this._b +
                        this._b * (c / this.averageFieldLength[s])) +
                      g)),
          ...
          (o.Builder.prototype.createTokenSet = function () {
            this.tokenSet = o.TokenSet.fromArray(
          ...
          (o.MatchData.prototype.combine = function (e) {
            for (var t = Object.keys(e.metadata), n = 0; n < t.length; n++) {
              ...
              void 0 == this.metadata[r] &&
                (this.metadata[r] = Object.create(null));
              for (var o = 0; o < i.length; o++) {
                var a = i[o],
                  s = Object.keys(e.metadata[r][a]);
                void 0 == this.metadata[r][a] &&
                  (this.metadata[r][a] = Object.create(null));
                for (var c = 0; c < s.length; c++) {
                  var u = s[c];
                  void 0 == this.metadata[r][a][u]
                    ? (this.metadata[r][a][u] = e.metadata[r][a][u])
                    : (this.metadata[r][a][u] = this.metadata[r][a][u].concat(
                        e.metadata[r][a][u],
                      ));
                }
              }
          ...
          (o.Query.wildcard = new String("*")),
          (o.Query.wildcard.NONE = 0),
          (o.Query.wildcard.LEADING = 1),
          (o.Query.wildcard.TRAILING = 2),
          (o.Query.prototype.clause = function (e) {
            return (
              "fields" in e || (e.fields = this.allFields),
              "boost" in e || (e.boost = 1),
              "usePipeline" in e || (e.usePipeline = !0),
              "wildcard" in e || (e.wildcard = o.Query.wildcard.NONE),
              e.wildcard & o.Query.wildcard.LEADING &&
                e.term.charAt(0) != o.Query.wildcard &&
                (e.term = "*" + e.term),
              e.wildcard & o.Query.wildcard.TRAILING &&
                e.term.slice(-1) != o.Query.wildcard &&
                (e.term = e.term + "*"),
              this.clauses.push(e),
              this
            );
          ...
          (o.QueryParseError.prototype = new Error()),
          (o.QueryLexer = function (e) {
            (this.lexemes = []),
              (this.str = e),
          ...
          (o.QueryLexer.EOS = "EOS"),
          (o.QueryLexer.FIELD = "FIELD"),
          (o.QueryLexer.TERM = "TERM"),
          (o.QueryLexer.EDIT_DISTANCE = "EDIT_DISTANCE"),
          (o.QueryLexer.BOOST = "BOOST"),
          (o.QueryLexer.lexField = function (e) {
            return (
              e.backup(),
              e.emit(o.QueryLexer.FIELD),
              e.ignore(),
              o.QueryLexer.lexText
            );
          }),
          (o.QueryLexer.lexTerm = function (e) {
            if (
              (e.width() > 1 && (e.backup(), e.emit(o.QueryLexer.TERM)),
              e.ignore(),
              e.more())
            )
              return o.QueryLexer.lexText;
          }),
          (o.QueryLexer.lexEditDistance = function (e) {
            return (
              e.ignore(),
              e.acceptDigitRun(),
              e.emit(o.QueryLexer.EDIT_DISTANCE),
              o.QueryLexer.lexText
            );
          }),
          ...
          (o.QueryLexer.termSeparator = o.tokenizer.separator),
          (o.QueryLexer.lexText = function (e) {
            for (;;) {
              var t = e.next();
              ...
              if (92 != t.charCodeAt(0)) {
                ...
                if (t.match(o.QueryLexer.termSeparator))
                  return o.QueryLexer.lexTerm;
              } else e.escapeCharacter();
            }
          }),
          (o.QueryParser = function (e, t) {
            (this.lexer = new o.QueryLexer(e)),
              (this.query = t),
              (this.currentClause = {}),
              (this.lexemeIdx = 0);
          }),
              ...
              switch (t.type) {
                ...
                default:
                  ...
                  throw (
                    ...
                    new o.QueryParseError(n, t.start, t.end))
                  );
              }
          }),
        ...
        c = (function (e) {
          function t(n) {
            ...
            if (a && 3 === a.length) {
              var s = a[1],
                c = a[2];
              (o.base_ = "https://api.github.com/users/" + s + "/repos"),
                (o.name_ = c);
            }
            return o;
          }
              ...
              return (function t() {
                var n =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : 0;
                return fetch(e.base_ + "?per_page=30&page=" + n)
                  .then(function (e) {
                    return e.json();
                  })
                  .then(function (r) {
                    ...
                    if (e.name_) {
                      ...
                      return i || 30 !== r.length
                        ? i
                          ? [
                              e.format_(i.stargazers_count) + " Stars",
                              e.format_(i.forks_count) + " Forks",
                            ]
                          : []
                        : t(n + 1);
                    }
              ...
              for (
                ...
                try {
                  ...
                  if (
                    ((p = n.read
                      ? n.read(p, m)
                      : n(p, m) || p.replace(d, decodeURIComponent)),
                    this.json)
                  )
                    try {
                      p = JSON.parse(p);
      ...
      var i = (function () {
        ...
        return (
          (e.prototype.update = function () {
            ...
            e !== this.active_ &&
              (this.el_.dataset.mdState = (this.active_ = e) ? "hidden" : "");
          }),
          (e.prototype.reset = function () {
