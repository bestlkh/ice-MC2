...
methodDraw.addExtension("mathsymbols", function () {
  ...
  function loadLibrary(cat_id) {
    ...
    if (!lib) {
      ...
      $.getJSON(
        "extensions/mathlib/" + cat_id + ".json",
        ...
        if (cur_shape_id == "root" && selectedElements.length > 0) {
          ...
          for (i = 0; i < selectedElements.length; i++) {
            ...
            if (selected != null) {
              ...
              if (bb_max_x < selectedBB.x + selectedBB.width)
                bb_max_x = selectedBB.x + selectedBB.width;
              if (bb_max_y < selectedBB.y + selectedBB.height)
                bb_max_y = selectedBB.y + selectedBB.height;
            }
          }
