...
keyHash["a"] = [ svgEditSymbols.lowercase_a, svgEditSymbols.lowercase_alpha, svgEditSymbols.uppercase_a, svgEditSymbols.uppercase_alpha,'a', 'A', '3B1','2200', '2227', '2135', '2220'];
keyHash["b"] = [ svgEditSymbols.lowercase_b, svgEditSymbols.lowercase_beta, svgEditSymbols.uppercase_b, svgEditSymbols.uppercase_beta,'b', 'B', '3B2', '2235'];
keyHash["c"] = [ svgEditSymbols.lowercase_c, svgEditSymbols.lowercase_chi, svgEditSymbols.uppercase_c, svgEditSymbols.uppercase_chi,'c', 'C', '2218', '2102'];
keyHash["d"] = [ svgEditSymbols.lowercase_d, svgEditSymbols.lowercase_delta, svgEditSymbols.uppercase_d, svgEditSymbols.uppercase_delta,'d', 'D', '3B4', '394', '2202', '247'];
keyHash["e"] = [ svgEditSymbols.lowercase_e, svgEditSymbols.lowercase_epsilon, svgEditSymbols.symbol_element_of, svgEditSymbols.symbol_not_an_element_of, svgEditSymbols.symbol_empty_set, svgEditSymbols.lowercase_eta, svgEditSymbols.uppercase_e, svgEditSymbols.uppercase_epsilon, svgEditSymbols.uppercase_eta, 'e', 'E', '2208', '2209', '3B5', '3F5', '2203'];
keyHash["f"] = [ svgEditSymbols.lowercase_f, svgEditSymbols.uppercase_f,'f', 'F', '2131'];
keyHash["g"] = [ svgEditSymbols.lowercase_g, svgEditSymbols.lowercase_gamma, svgEditSymbols.uppercase_g, svgEditSymbols.uppercase_gamma,'g', 'G', '3B3', '393'];
keyHash["h"] = [ svgEditSymbols.lowercase_h, svgEditSymbols.uppercase_h,'h', 'H', '210C', '210F'];
keyHash["i"] = [ svgEditSymbols.lowercase_i, svgEditSymbols.lowercase_iota, svgEditSymbols.symbol_infinity, svgEditSymbols.symbol_integral, svgEditSymbols.uppercase_i, svgEditSymbols.uppercase_iota,'i', 'I', '222B', '2111', '221E', '3B9'];
keyHash["j"] = [ svgEditSymbols.lowercase_j, svgEditSymbols.uppercase_j,'j', 'J'];
keyHash["k"] = [ svgEditSymbols.lowercase_k, svgEditSymbols.lowercase_kappa, svgEditSymbols.uppercase_k, svgEditSymbols.uppercase_kappa,'k', 'K', '3BA'];
keyHash["l"] = [ svgEditSymbols.lowercase_l, svgEditSymbols.lowercase_lamda, svgEditSymbols.uppercase_l, svgEditSymbols.uppercase_lambda,'l', 'L', '2112', '3BB', '<', '2264', '2113'];
keyHash["m"] = [ svgEditSymbols.lowercase_m, svgEditSymbols.lowercase_mu, svgEditSymbols.uppercase_m, svgEditSymbols.uppercase_mu, 'm', 'M', '3BC'];
keyHash["n"] = [ svgEditSymbols.lowercase_n, svgEditSymbols.lowercase_nu, svgEditSymbols.uppercase_n,svgEditSymbols.uppercase_nu,'n', 'N', '2115', '843', '2205'];
keyHash["o"] = [ svgEditSymbols.lowercase_o, svgEditSymbols.lowercase_omega, svgEditSymbols.lowercase_omicron, svgEditSymbols.uppercase_o, svgEditSymbols.uppercase_omega, svgEditSymbols.uppercase_omicron,'o', 'O', '3A9', '3C9', '2218', '2295', '2296', '2297', '2298', '2299'];
keyHash["p"] = [ svgEditSymbols.lowercase_p, svgEditSymbols.lowercase_phi, svgEditSymbols.lowercase_pi, svgEditSymbols.lowercase_psi, svgEditSymbols.uppercase_p,  svgEditSymbols.uppercase_phi, svgEditSymbols.uppercase_pi, svgEditSymbols.uppercase_psi,'p', 'P', '3A0', '3C0', '3A6', '3A8', '3C8', '3D5', '2202'];
keyHash["q"] = [ svgEditSymbols.lowercase_q, svgEditSymbols.uppercase_q, svgEditSymbols.symbol_doublestruck_capital_q,'q', 'Q', '211A'];
keyHash["r"] = [ svgEditSymbols.lowercase_r, svgEditSymbols.lowercase_rho, svgEditSymbols.uppercase_r, svgEditSymbols.uppercase_rho, svgEditSymbols.symbol_doublestruck_capital_r,'r', 'R', '211D', '211C', '3C1', '221A'];
keyHash["s"] = [ svgEditSymbols.lowercase_s, svgEditSymbols.lowercase_sigma, svgEditSymbols.uppercase_s, svgEditSymbols.uppercase_sigma, svgEditSymbols.SUM, svgEditSymbols.SQRT,'s', 'S', '2211', '3C3', '2286', '2282', '3C2'];
keyHash["t"] = [ svgEditSymbols.lowercase_t, svgEditSymbols.lowercase_tau, svgEditSymbols.lowercase_theta, svgEditSymbols.uppercase_t, svgEditSymbols.uppercase_tau, svgEditSymbols.uppercase_theta,'t', 'T', '3B8', '3C4', 'D7', '3D1', '398'];
keyHash["u"] = [ svgEditSymbols.lowercase_u, svgEditSymbols.lowercase_upsilon, svgEditSymbols.symbol_nary_union, svgEditSymbols.uppercase_u, svgEditSymbols.uppercase_upsilon,'u', 'U', '222A', '2229', '3C5'];
keyHash["v"] = [ svgEditSymbols.lowercase_v, svgEditSymbols.uppercase_v,'v', 'V', '2228'];
keyHash["w"] = [ svgEditSymbols.lowercase_w, svgEditSymbols.uppercase_w,'w', 'W'];
keyHash["x"] = [ svgEditSymbols.lowercase_x, svgEditSymbols.lowercase_xi, svgEditSymbols.uppercase_x, svgEditSymbols.uppercase_xi,'x', 'X', '3C7', '3BE', '39E'];
keyHash["y"] = [ svgEditSymbols.lowercase_y, svgEditSymbols.uppercase_y,'y', 'Y'];
keyHash["z"] = [ svgEditSymbols.lowercase_z, svgEditSymbols.lowercase_zeta, svgEditSymbols.uppercase_z, svgEditSymbols.uppercase_zeta, svgEditSymbols.symbol_doublestruck_capital_z, 'z', 'Z', '2124', '3B6'];

keyHash["&"] = [ svgEditSymbols.symbol_ampersand ];
keyHash["^"] = [ svgEditSymbols.symbol_asciicircum ];
keyHash["~"] = [ svgEditSymbols.symbol_asciitilde,'~', '2243', '2248', '2245' ];
keyHash["*"] = [ svgEditSymbols.symbol_asterisk, svgEditSymbols.symbol_multiplication_sign ];
keyHash["@"] = [ svgEditSymbols.symbol_at ];
keyHash["'\'"] = [ svgEditSymbols.symbol_backslash ];
keyHash["|"] = [ svgEditSymbols.symbol_bar,'|', '2224', '2225', '2226'];
keyHash["["] = [ svgEditSymbols.symbol_braceleft, svgEditSymbols.symbol_left_square_bracket, '[', '230A', '2309'];
keyHash["]"] = [ svgEditSymbols.symbol_braceright, svgEditSymbols.symbol_right_square_bracket,']', '230B', '2308'];
keyHash["("] = [ svgEditSymbols.symbol_braceleft, svgEditSymbols.symbol_left_parenthesis, svgEditSymbols.symbol_parenleft];
keyHash[")"] = [ svgEditSymbols.symbol_braceright, svgEditSymbols.symbol_right_parenthesis, svgEditSymbols.symbol_parenright];
keyHash[":"] = [ svgEditSymbols.symbol_colon ];
keyHash["."] = [ svgEditSymbols.symbol_comma, svgEditSymbols.symbol_period, svgEditSymbols.symbol_full_stop, svgEditSymbols.symbol_middle_dot, '.', '95', '2218', '2235', '2234'];
keyHash["$"] = [ svgEditSymbols.symbol_dollar];
keyHash["="] = [ svgEditSymbols.symbol_equal, svgEditSymbols.symbol_equals_sign, '=', '2260', '2261', '2243', '2248', '2245', '221D' ];
keyHash["!"] = [ svgEditSymbols.symbol_exclam ];
keyHash["`"] = [ svgEditSymbols.symbol_grave ];
keyHash["-"] = [ svgEditSymbols.symbol_hyphen ];
keyHash["{"] = [ svgEditSymbols.symbol_left_curly_bracket ];
keyHash["}"] = [ svgEditSymbols.symbol_right_curly_bracket ];
keyHash["#"] = [ svgEditSymbols.symbol_numbersign ];
keyHash["?"] = [ svgEditSymbols.symbol_question ];
keyHash['"'] = [ svgEditSymbols.symbol_quotedbl ];
keyHash["'"] = [ svgEditSymbols.symbol_quotesingle ];
keyHash[';'] = [ svgEditSymbols.symbol_semicolon ];
keyHash['_'] = [ svgEditSymbols.symbol_underscore ];

keyHash["1"] = [ svgEditSymbols.symbol_one ];
keyHash["2"] = [ svgEditSymbols.symbol_two ];
keyHash["3"] = [ svgEditSymbols.symbol_three ];
keyHash["4"] = [ svgEditSymbols.symbol_four ];
keyHash["5"] = [ svgEditSymbols.symbol_five ];
keyHash["6"] = [ svgEditSymbols.symbol_six ];
keyHash["7"] = [ svgEditSymbols.symbol_seven ];
keyHash["8"] = [ svgEditSymbols.symbol_eight ];
keyHash["9"] = [ svgEditSymbols.symbol_nine ];
keyHash["0"] = [ svgEditSymbols.symbol_zero ];

keyHash["<"] = [ svgEditSymbols.symbol_greater, svgEditSymbols.symbol_greaterthan_or_equal_to, svgEditSymbols.symbol_greaterthan_sign,'<', '2264', '2266', '226A', '226E'];
keyHash[">"] = [ svgEditSymbols.symbol_less, svgEditSymbols.symbol_lessthan_or_equal_to, svgEditSymbols.symbol_lessthan_sign, svgEditSymbols.symbol_combining_double_rightwards_arrow_below, '>', '→', '2265', '2267', '226B', '226F'];
keyHash["+"] = [ svgEditSymbols.symbol_plus, svgEditSymbols.symbol_plusminus_sign,svgEditSymbols.symbol_plus_sign, '+', 'B1', '2213', '2295'];
keyHash["−"] = [ svgEditSymbols.symbol_vertical_line, '−', 'B1', '2213', '2296'];
keyHash["/"] = [ svgEditSymbols.symbol_slash, svgEditSymbols.symbol_division_sign,'/', 'F7', '2298'];
...
this.moveSelectedElements = function(dx, dy, undoable, elements) {
  ...
  var elementIn = true;
  var direction = 1; // 1 is for right, -1 is for left
...
var moveCursorAbs = this.moveCursorAbs;
  ...
  this.pullAllAtCursor = function(width, excl) {
    var spacing = width;
    if(!width) {
      if (width == 0) {
        return;
    ...
    var regionCondFunc = function(region) {
      var res = (region.wall.left <= cursor_x 
              && cursor_x < region.wall.right
  ...
  var pullAllAtCursor = this.pullAllAtCursor;
