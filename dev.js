...
const LESS_FILES = [
  [
    "public/app/styles/chatroom/main.less",
    "public/app/styles/chatroom/main.css",
  ],
  ["public/app/styles/ice/main.less", "public/app/styles/ice/main.css"],
  [
    "public/app/styles/latex-preview/main.less",
    "public/app/styles/latex-preview/main.css",
  ],
];
...
const JS_FILES = [
  ...
  [
    "public/app/js/lib/alert/alert.js",
    "public/app/js/lib/alert/alert.bundle.js",
  ],
  [
    "public/app/js/lib/driver/driver.js",
    "public/app/js/lib/driver/driver.bundle.js",
  ],
  [
    "public/app/js/lib/recognition/tool.js",
    "public/app/js/lib/recognition/tool.bundle.js",
  ],
  [
    "public/app/js/lib/utilities/ImageUtility.js",
    "public/app/js/lib/utilities/ImageUtility.bundle.js",
  ],
];
...
function compileLess(input, output) {
  ...
  fs.readFile(input, "utf8", function (err, data) {
    if (err) {
      ...
      // Render LESS
      less.render(data, { filename: input }).then(
        function (out) {
          // Write CSS
...
console.log(
  "JavaScript files will be transformed using babel, then bundled using browserify.",
);
