...
(function () {
              ...
              try {
                document.addEventListener
                  ...
                  : document.attachEvent &&
                    ...
                    (document.detachEvent("onreadystatechange", b), d());
              } catch (a) {}
            }
            function d() {
      ...
      extend: function (b) {
        ...
        for (var e = 1; e < a; e++) {
          var n = arguments[e],
            i;
          for (i in n)
            if (d === true || b[i] == void 0) if (!h || i in h) b[i] = n[i];
        }
        return b;
      },
  ...
  CKEDITOR.dtd = (function () {
    var a = CKEDITOR.tools.extend,
      e = function (a, d) {
        for (
          var b = CKEDITOR.tools.clone(a), h = 1;
          h < arguments.length;
          h++
        ) {
          var d = arguments[h],
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getPreviousSourceNode: function (a, e, b) {
      ...
      return !a || (b && b(a) === false)
        ? null
        : e && a.type != e
        ? a.getPreviousSourceNode(false, e, b)
        : a;
    },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      isEmptyInlineRemoveable: function () {
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          var e = a.getItem(b);
          if (
            !(e.type == CKEDITOR.NODE_ELEMENT && e.data("cke-bookmark")) &&
            ((e.type == CKEDITOR.NODE_ELEMENT &&
              !e.isEmptyInlineRemoveable()) ||
              (e.type == CKEDITOR.NODE_TEXT &&
                CKEDITOR.tools.trim(e.getText())))
          )
            return false;
        }
        return true;
      ...
      mergeSiblings: (function () {
        function a(b, d, c) {
          if (d && d.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (b.isIdentical(d)) {
              for (var j = c ? b.getLast() : b.getFirst(); e.length; )
                e.shift().move(b, !c);
              d.moveChildren(b, !c);
              d.remove();
      ...
      getDocumentPosition: function (a) {
        ...
        if (document.documentElement.getBoundingClientRect) {
          ...
          for (
            e = null;
            i && !(i.getName() == "body" || i.getName() == "html");
        ...
        if (a) {
          ...
          if (!i.equals(e) && i.$.frameElement) {
            a = new CKEDITOR.dom.element(i.$.frameElement).getDocumentPosition(
              a,
            );
            b = b + a.x;
            c = c + a.y;
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = f ? j.getBody() : j.getDocumentElement());
        j = a.getWindow();
        i = s(this, j);
        var p = s(a, j),
          y = this.$.offsetHeight;
        ...
        for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
          ...
          if (!(j in b))
            if (j == "checked" && (o = this.getAttribute(j)))
              ...
              i.specified ||
              (CKEDITOR.env.ie && i.nodeValue && j == "value")
            ) {
  ...
  (function () {
          ...
          f.type == CKEDITOR.NODE_ELEMENT &&
            (f =
              e > 0
                ...
                : k(f, true) === false
                ? null
                : f.getPreviousSourceNode(true, t, k));
        else {
          f = d;
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function (a) {
      return this.getComputedStyle("float") == "none" &&
        !(this.getComputedStyle("position") in d) &&
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark2: (function () {
        function a(b) {
          ...
          var e = d;
          f =
            f.type != CKEDITOR.NODE_ELEMENT || e === 0 || e == f.getChildCount()
              ? 0
              : f.getChild(e - 1).type == CKEDITOR.NODE_TEXT &&
      ...
      enlarge: function (a, b) {
        ...
        switch (a) {
                  ...
                  if (l.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                      ...
                      if (/[^\s\ufeff]/.test(j)) l = null;
                        ...
                        for (
                          var g = l.$.getElementsByTagName("*"), n = 0, E;
                          (E = g[n++]);

                        )
                          if (
                            !CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]
                          ) {
                            l = null;
                            break;
                          }
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var z,
              M,
              Q = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              z,
              !z.is("br") &&
                ((!k && this.checkStartOfBlock()) || (k && z.contains(k)))
            ...
            this.setEndAt(
              z,
              (!k && this.checkEndOfBlock()) || (k && z.contains(k))
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          if (f && f.type == CKEDITOR.NODE_TEXT)
            if (h)
              if (h >= f.getLength()) d.setStartAfter(f);
              else {
                d.setStartBefore(f);
                k = 0;
              }
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          g =
            f.endContainer.hasAscendant("pre", true) ||
        ...
        for (this._.nextNode = null; p; ) {
          ...
          if (k) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (k = 0);
            ...
            if (
              ...
              p.getAttribute("contenteditable") == "false"
            ) {
              b = p;
              c(this, a, b);
              break;
            } else if (
              p.isBlockBoundary(this.forceBrBreak && !m && { br: 1 })
            ) {
              if (t == "br") k = 1;
        ...
        if (!b) {
          ...
          if (
            ...
            this._.nextNode = b.equals(f)
              ? null
              : e(g.getBoundaryNodes().endNode, 1, f);
        }
        if (s)
          (s = b.getPrevious()) &&
        ...
        if (u)
          (s = b.getLast()) &&
            s.type == CKEDITOR.NODE_ELEMENT &&
            s.getName() == "br" &&
            (!CKEDITOR.env.needsBrFiller || s.getPrevious(h) || s.getNext(h)) &&
            s.remove();
        if (!this._.nextNode)
  ...
  (function () {
    function a(a, b, c, f, k) {
      var m = b.name;
      if (
        (f || typeof a.elements != "function" || a.elements(m)) &&
        (!a.match || a.match(b))
      ) {
        if ((f = !k)) {
    ...
    function u(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || t.$block[a.name])
      );
    }
    function f(a, b, c) {
      var d = a.name;
      if (t.$empty[d] || !a.children.length)
        ...
        if (b == "br") {
          ...
          if (f) {
            ...
            for (
              var e =
                  f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body",
                l,
                k = d.length;
              k > 0;
              ...
              if (
                ...
                (m.type == CKEDITOR.NODE_TEXT ||
                  (m.type == CKEDITOR.NODE_ELEMENT && t.$inline[m.name]))
              ) {
                if (!l) {
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, d, e) {
          ...
          function (a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                d.children.length == 1 &&
                  (f = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  h(f, m, l, c, b);
                c = !c.length;
              }
              c || k.push(a);
        ...
        for (
          var r,
            a = [],
            e =
              A[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
          (d = k.pop());
        ...
        for (; (r = a.pop()); ) {
          ...
          if (d.parent)
            switch (r.check) {
              case "it":
                t.$removeEmpty[d.name] && !d.children.length
                  ? f(d, e, a)
                  : o(d) || f(d, e, a);
                break;
              case "el-up":
                d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  !t[d.parent.name][d.name] &&
                  f(d, e, a);
                break;
              case "parent-down":
                d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
      ...
      check: function (a, b, d) {
        ...
        b =
          l.length > 0
            ? false
            : CKEDITOR.tools.objectCompare(e.attributes, m.attributes, true)
            ? true
            : false;
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function (a, e, b) {
      ...
      for (
        var c = this.loaded, d = this.registered, h = [], g = {}, n = {}, i = 0;
        i < a.length;
        i++
      ) {
        var j = a[i];
    ...
    function o(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var l in c) {
          ...
          if (g && !a.lang[l]) {
            ...
            if (CKEDITOR.tools.indexOf(g, a.langCode) >= 0) i = a.langCode;
              ...
              i =
                i != a.langCode && CKEDITOR.tools.indexOf(g, i) >= 0
                  ? i
                  : CKEDITOR.tools.indexOf(g, "en") >= 0
                  ? "en"
                  : g[0];
            }
        ...
        CKEDITOR.scriptLoader.load(k, function () {
          for (
            var c = ["beforeInit", "init", "afterInit"], k = 0;
            k < c.length;
            k++
          )
            for (var m = 0; m < d.length; m++) {
              ...
              k === 0 &&
                ...
                l.lang &&
                l.langEntries &&
                (a.lang[l.name] = l.langEntries[e[m]]);
              if (l[c[k]]) l[c[k]](a);
            }
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var c = CKEDITOR.document.getElementsByTag(b), d = 0, h = c.count();
          d < h;
          d++
        ) {
          a = c.getItem(d);
  ...
  (function () {
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
      ...
      j.setStyle(
        "height",
        Math.max(
          b - (c ? 0 : (e.$.offsetHeight || 0) - (j.$.clientHeight || 0)),
          0,
        ) + "px",
      );
      o && (o.style.width = "100%");
  ...
  (function () {
    ...
    function e(a, b) {
      ...
      if (
        e &&
        e.isBlockBoundary() &&
        (!d || !(d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary())) &&
        !e.is("pre") &&
        !e.getBogus()
      )
        return e;
    ...
    function d(a, b) {
      return function (c) {
        var e = CKEDITOR.dom.element.get(
      ...
      proto: {
        ...
        insertElementIntoSelection: function (a) {
          ...
          if (this.insertElementIntoRange(a, d)) {
            ...
            if (k)
              if (
                (k = a.getNext(function (a) {
                  return c(a) && !i(a);
                })) &&
                k.type == CKEDITOR.NODE_ELEMENT &&
                k.is(CKEDITOR.dtd.$block)
              )
                k.getDtd()["#"]
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (c in k) {
                ...
                if (
                  ...
                  if (
                    (i = g.block) &&
                    (n = i[c ? "getPrevious" : "getNext"](o)) &&
                    n.type == CKEDITOR.NODE_ELEMENT &&
                    n.is("table") &&
                    m[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                  ) {
                    a.fire("saveSnapshot");
                    m[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                      i.remove();
                    ...
                    m.checkBoundaryOfElement(
                      j,
                      c ? CKEDITOR.START : CKEDITOR.END,
                    ) &&
                    (n = j[c ? "getPrevious" : "getNext"](o))
                  ) {
                    a.fire("saveSnapshot");
                    m["moveToElementEdit" + (c ? "End" : "Start")](n);
                    m.checkStartOfBlock() && m.checkEndOfBlock()
                      ? n.remove()
                      : m.select();
                    a.fire("saveSnapshot");
                    e = 1;
    ...
    var s = (function () {
        ...
        function k(b, c, e, d) {
          ...
          if (
            (m = new CKEDITOR.dom.walker(l).next()) &&
            a(m) &&
            h[m.getName()] &&
            (g = m.getPrevious()) &&
            a(g) &&
        ...
        return function (h, j, o) {
          ...
          if (!x.checkReadOnly()) {
            var v =
                new CKEDITOR.dom.elementPath(x.startContainer, x.root)
                  .blockLimit || x.root,
              j = {
                type: j,
                dontFilter: s,
            ...
            if (
              j.type == "text" &&
              q.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)
            ) {
            ...
            for (
              ...
              (D =
                a(q.startContainer) &&
                q.startContainer.getChild(q.startOffset - 1)) &&
              a(D) &&
              D.isBlockBoundary() &&
              H.contains(D);
            ...
            if ((w = o)) {
              ...
              if (/^\s+|\s+$/.test(o) && "span" in CKEDITOR.dtd[D])
                var u = '<span data-cke-marker="1">&nbsp;</span>',
                  o = u + o + u;
            ...
            if (w) {
              ...
              C = v.getPosition(H);
              X =
                !!v.getCommonAncestor(H) &&
                C != CKEDITOR.POSITION_IDENTICAL &&
                !(
                  C &
              ...
              for (l(H, F); w < H.length; w++) {
                ...
                if (B) s = w > 0;
                  ...
                  if (
                    !C.isBlock &&
                    j.editor.config.autoParagraph !== false &&
                    j.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                    j.editor.editable().equals(B.blockLimit) &&
                    !B.block &&
                    (O =
                      j.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                      j.editor.config.autoParagraph !== false
                        ? j.editor.activeEnterMode == CKEDITOR.ENTER_DIV
                          ? "div"
                          : "p"
                        : false)
                  ) {
            ...
            if (R)
              for (; (G = R.pop()); )
                CKEDITOR.env.needsBrFiller
                  ? G.appendBogus()
                  : G.append(J.document.createText(" "));
            ...
            if (!j.dontMoveCaret) {
              for (
                ...
                if (G.isBlockBoundary())
                  J.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
                else {
      ...
      u = (function () {
        ...
        return function (e) {
          ...
          if (l.is("table")) {
            ...
            l.is("tr") &&
              (l = b(l, l.getParent().is("thead") ? "th" : "td", g));
  ...
  (function () {
    ...
    function c(a) {
      function b(c, e) {
        return !c || c.type == CKEDITOR.NODE_TEXT
          ? false
          : a.clone()["moveToElementEdit" + (e ? "End" : "Start")](c);
      }
    ...
    function h(a, b) {
      ...
      if (c) {
        if (b !== false) {
          var e,
            d = a.getDocument().getSelection().getNative(),
        ...
        if (b[e]) {
          ...
          if (d.length == 1 && f.collapsed)
            if (
              (e =
                f[
                  e < 38 ? "getPreviousEditableNode" : "getNextEditableNode"
                ]()) &&
              e.type == CKEDITOR.NODE_ELEMENT &&
    ...
    CKEDITOR.on("instanceCreated", function (b) {
      ...
      d.on("contentDom", function () {
        ...
        k.attachListener(
          ...
          function () {
            o &&
              CKEDITOR.env.webkit &&
              (o =
                d._.previousActive && d._.previousActive.equals(b.getActive()));
            d.unlockSelection(o);
            o = 0;
          },
          null,
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera || i) {
          ...
          f
            ? k.attachListener(k, "beforedeactivate", q, null, null, -1)
            : k.attachListener(d, "selectionCheck", q, null, null, -1);
          k.attachListener(
            k,
        ...
        if (
          ...
          k.attachListener(
            CKEDITOR.env.ie ? k : b.getDocumentElement(),
            "mouseup",
            e,
            d,
          );
        ...
        b.on(
          ...
          function () {
            var a = b.editable(),
              c = d(a);
            c &&
              (c.getCustomData("ready") ? h(a) : c.setCustomData("ready", 1));
          },
          null,
          null,
          -1,
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (
        !g ||
        !(g.type == CKEDITOR.NODE_ELEMENT || g.type == CKEDITOR.NODE_TEXT) ||
        (!this.root.equals(g) && !this.root.contains(g))
      ) {
                  ...
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var f = c.item(e),
                        ...
                        g = 0,
                        a = new CKEDITOR.dom.range(this.root);
                      g < k.childNodes.length && k.childNodes[g] != f;
                      g++
                    );
              ...
              if (!f.collapsed) {
                if (f.startContainer.isReadOnly())
                  for (var b = f.startContainer, g; b; ) {
                    if (
                      ((g = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body")) ||
                      !b.isReadOnly()
                    )
                      break;
                    g &&
                ...
                g &&
                  ...
                  (j ? i.setEndAfter(g) : i.setEndBefore(g));
            ...
            if (b) this.fake(b);
              ...
              if (f) {
                ...
                if (p) {
                  ...
                  j =
                    !(j && j.getText && j.getText().match(d)) &&
                    (i ||
                      !g.hasPrevious() ||
                      (g.getPrevious().is && g.getPrevious().is("br")));
                ...
                for (o = 0; o < a.length; o++) {
                  ...
                  if (
                    ...
                    if (
                      (!d && !e && j.is(CKEDITOR.dtd.$removeEmpty)) ||
    ...
    if (!b) {
      ...
      this.on("selectionChange", function (a) {
        for (var d = 0; d < b.length; d++) {
          var e = b[d],
            g = e.style.checkActive(a.data.path)
  ...
  (function () {
          ...
          if (n.equals(o)) {
            ...
            if (p && i && CKEDITOR.dtd.$block[s])
              for (
                var t = n,
                  ...
                  A = x.length,
                  I = 0,
                  t = A && new CKEDITOR.dom.range(t.getDocument());
                I < A;
                ++I
              ) {
                var z = x[I],
            ...
            x = s
              ? !k[s] || r
                ...
                ? 0
                : (n.getPosition(o) | M) == M &&
                  (!g.childRule || g.childRule(n))
              : 1;
            if (x)
              if (
                (x = n.getParent()) &&
                ((x.getDtd() || CKEDITOR.dtd.span)[f] || h) &&
                (!g.parentRule || g.parentRule(x))
              ) {
                if (
                  !q &&
                  (!s ||
                ...
                if (
                  ...
                  p ||
                  (s == CKEDITOR.NODE_ELEMENT && !n.getChildCount())
                ) {
                  for (
                    var s = n, W;
                    (j = !s.getNext(E)) &&
      ...
      if (a.collapsed) {
        for (
          var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
            ...
            j = 0,
            h;
          j < e.elements.length && (h = e.elements[j]);
          j++
        ) {
    ...
    function s(a, b) {
      ...
      for (h in d)
        if (
          !(
            (h == "class" || this._.definition.fullMatch) &&
            a.getAttribute(h) != t(h, d[h])
          ) &&
          !(b && h.slice(0, 5) == "data-")
        ) {
          g = a.hasAttribute(h);
      ...
      for (var j in c)
        if (
          !(this._.definition.fullMatch && a.getStyle(j) != t(j, c[j], true))
        ) {
          g = g || !!a.getStyle(j);
          a.removeStyle(j);
        }
  ...
  (function () {
    function a(a, c, d) {
      ...
      if (g.equals(i.getPrevious())) {
        c.startOffset =
          c.startOffset - g.getLength() - a.getPrevious().getLength();
        g = a.getNext();
    ...
    function e(b) {
      ...
      if (c)
        for (
          ...
          if (
            d.ie &&
            (g.replace(/^ie/, "") == d.version || (d.quirks && g == "iequirks"))
          )
            g = "ie";
          if (d[g]) {
            b = b + ("_" + c[e]);
      ...
      proto: {
        ...
        show: function (a, b, c, k) {
          ...
          if (!i) {
            ...
            d["rtl" == j.lang.dir ? 37 : 39] = CKEDITOR.env.ie
              ? "mouseup"
              : "click";
      ...
      init: function (a) {
        ...
        a.on("uiSpace", function (c) {
          if (c.data.space == a.config.toolbarLocation) {
            ...
            for (
              var o = a.toolbox.toolbars, f = w(a), k = 0;
              k < f.length;
              k++
            ) {
              var i,
                    ...
                    if (p)
                      if (p.type == CKEDITOR.UI_SEPARATOR) j = e && p;
                        ...
                        if (!l) {
                          ...
                          var q = o.push(l) - 1;
                          0 < q &&
                            ((l.previous = o[q - 1]), (l.previous.next = l));
                        }
                        n
                          ? e ||
                            (b.push(
