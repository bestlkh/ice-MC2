(function () {
  function r(i, z, t) {
    ...
    if (Ba) for (var B in z) i.setAttribute(B, z[B]);
    else
      for (B in z) {
        var W = z[B],
          w = i[B];
  ...
  jQuery.fn.jGraduate = function (i) {
    ...
    return this.each(function () {
      function t(c, a, d, h, f) {
        var l =
          f || r("stop", { "stop-color": a, "stop-opacity": d, offset: c }, g);
        if (f) {
        ...
        $(X)
          ...
          .dblclick(function () {
            ...
            for (
              var M = this,
                I = +l.getAttribute("stop-opacity") || 1,
                C = l.getAttribute("stop-color") || 1,
                Y = (parseFloat(I) * 255).toString(16);
              Y.length < 2;

            )
              Y = "0" + Y;
            a = C.substr(1) + Y;
            $("#" + b + "_jGraduate_stopPicker")
              ...
              .jPicker(
                {
                  ...
                  images: { clientPath: o.images.clientPath },
                  color: { active: a, alphaSupport: true },
                },
                function (Z) {
      ...
      if (s) {
        ...
        $.extend(true, e, {
          paint: new $.jGraduate.Paint({ copy: o.paint }),
          okCallback: ($.isFunction(z[1]) && z[1]) || null,
          cancelCallback: ($.isFunction(z[2]) && z[2]) || null,
        });
        e.position();
        var u = null,
          N = $(window);
        ...
        if (ba) {
          ...
          if (K === "string")
            ...
            t(
              1,
              o.newstop.color || "#" + u,
              "opac" in o.newstop ? o.newstop.opac : 1,
            );
        }
        ...
        var sa = $("<div/>")
            ...
            .text(1)
            .css({ top: K * j, left: u * j })
            .data("coord", "start")
            .appendTo(x),
          Da = sa
            .clone()
            .text(2)
            .css({ top: P * j, left: y * j })
            .attr("title", "End stop")
            .data("coord", "end")
            .appendTo(x),
          ta = $("<div/>")
            ...
            .text("C")
            .css({ top: da * j, left: ca * j })
            .data("coord", "center")
            .appendTo(x),
          V = ta
            .clone()
            .text("F")
            .css({ top: ra * j, left: qa * j, display: "none" })
        ...
        var D,
          ...
          ha = ca,
          ia = da;
        H = r("svg", { width: "100%", height: 45 }, ga[0]);
        x = r(
          "pattern",
          {
            width: 16,
        ...
        r("image", { width: 16, height: 16 }, x).setAttributeNS(
          A.xlink,
          "xlink:href",
          o.images.clientPath + "map-opacity.png",
        );
        $(H).click(function (c) {
          S = ga.offset();
        ...
        n = {
          ...
          ellip: {
            handle: "#" + b + "_jGraduate_EllipArrows",
        ...
        var za = function (c) {
            var a =
              c.pageX -
              L.offset.left -
              parseInt(L.parent.css("border-left-width"));
            if (a > 145) a = 145;
            if (a <= 0) a = 0;
            var d = a - 5;
            a /= 145;
        ...
        Ca.jPicker(
          {
            window: { title: o.window.pickerTitle },
            images: { clientPath: o.images.clientPath },
            color: { active: u, alphaSupport: true },
          },
          function (c) {
            e.paint.type = "solidColor";
            e.paint.alpha = c.val("ahex")
              ? Math.round((c.val("a") / 255) * 100)
              : 100;
        ...
        ka.click(function () {
          ...
          if (c === "rg" || c === "lg") {
            ...
            $("#" + b + "_jgraduate_rect")[0].setAttribute(
              "fill",
              "url(#" + b + "_" + c + "_jgraduate_grad)",
            );
            p = c === "lg" ? "linearGradient" : "radialGradient";
            $("#" + b + "_jGraduate_OpacInput")
              .val(e.paint.alpha)
              .change();
            ...
            E =
              c === "rg" &&
              g.getAttribute("fx") != null &&
              !(ca == qa && da == ra);
            $("#" + b + "_jGraduate_focusCoord").toggle(E);
            if (E) $("#" + b + "_jGraduate_match_ctr")[0].checked = false;
          } else {
