...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
          ...
          <defs><linearGradient id="gradbox_"/></defs></svg>', 'text/xml');
                    ...
                    if (type === 'canvas') {
                        docElem.setAttribute('width', 60.5);
                    } else {
                        docElem.setAttribute('width', '100%');
                    }
                ...
                var Actions = function() {
                    ...
                    var tool_buttons = [
                        ...
                        {
                            sel: '#tool_deletebutton',
                            fn: deleteSelected,
                            evt: 'click',
                            kAy: ['U', true],
                        },
                        {
                            sel: '#tool_toggle_keyboard',
                            fn: MobileUI.toggleKeyboard,
                            evt: 'click',
                        },
                        {
                            sel: '#tool_fhpath',
                        ...
                        {
                            sel: '#tool_send_as_image',
                            fn: sendAsImage,
                            evt: 'click',
                        },
                        {
                            sel: '#tool_matrix',
                            fn: toggleMatrixSizeBtn,
                            evt: 'click',
                        },
                        {sel: '#tool_zoom_out', fn: zoomOutBtn, evt: 'click'},
                        {
                            sel: '#send-sheet-equation-button',
                            fn: clickConvert,
                            evt: 'click',
                        },
                        {
                            sel: '#send-sheet-image-button',
                            fn: sendAsImage,
                            evt: 'click',
                        },
                        {
                            sel: '#tool_send_mobile',
                            fn: convertAndSend,
                            evt: 'click',
                        },
                        ...
                        {
                            key: 'return', fn: function() {
                                svgCanvas.returnPressed();
                            },
                        },
                        {
                        ...
                        //Math Keys
                        {
                            key: [String.fromCharCode(97), true],
                            fn: function() {
                                svgCanvas.keyPressed('a');
                            },
                        },
                        {
                            key: ['shift+a', true], fn: function() {
                                svgCanvas.keyPressed('A');
                            },
                        },
                        {
                            key: ['b', true], fn: function() {
                                svgCanvas.keyPressed('b');
                            },
                        },
                        {
                            key: ['tab', true], fn: function() {
                                svgCanvas.keyPressed('b');
                            },
                        },
                        {
                            key: ['shift+b', true], fn: function() {
                                svgCanvas.keyPressed('B');
                            },
                        },
                        {
                            key: ['c', true], fn: function() {
                                svgCanvas.keyPressed('c');
                            },
                        },
                        {
                            key: ['shift+c', true], fn: function() {
                                svgCanvas.keyPressed('C');
                            },
                        },
                        {
                            key: ['d', true], fn: function() {
                                svgCanvas.keyPressed('d');
                            },
                        },
                        {
                            key: ['shift+d', true], fn: function() {
                                svgCanvas.keyPressed('D');
                            },
                        },
                        {
                            key: ['e', true], fn: function() {
                                svgCanvas.keyPressed('e');
                            },
                        },
                        {
                            key: ['shift+e', true], fn: function() {
                                svgCanvas.keyPressed('E');
                            },
                        },
                        {
                            key: ['f', true], fn: function() {
                                svgCanvas.keyPressed('f');
                            },
                        },
                        {
                            key: ['shift+f', true], fn: function() {
                                svgCanvas.keyPressed('F');
                            },
                        },
                        {
                            key: ['g', true], fn: function() {
                                svgCanvas.keyPressed('g');
                            },
                        },
                        {
                            key: ['shift+g', true], fn: function() {
                                svgCanvas.keyPressed('G');
                            },
                        },
                        {
                            key: ['h', true], fn: function() {
                                svgCanvas.keyPressed('h');
                            },
                        },
                        {
                            key: ['shift+h', true], fn: function() {
                                svgCanvas.keyPressed('H');
                            },
                        },
                        {
                            key: ['i', true], fn: function() {
                                svgCanvas.keyPressed('i');
                            },
                        },
                        {
                            key: ['shift+i', true], fn: function() {
                                svgCanvas.keyPressed('I');
                            },
                        },
                        {
                            key: ['j', true], fn: function() {
                                svgCanvas.keyPressed('j');
                            },
                        },
                        {
                            key: ['shift+j', true], fn: function() {
                                svgCanvas.keyPressed('J');
                            },
                        },
                        {
                            key: ['k', true], fn: function() {
                                svgCanvas.keyPressed('k');
                            },
                        },
                        {
                            key: ['shift+k', true], fn: function() {
                                svgCanvas.keyPressed('K');
                            },
                        },
                        {
                            key: ['l', true], fn: function() {
                                svgCanvas.keyPressed('l');
                            },
                        },
                        {
                            key: ['shift+l', true], fn: function() {
                                svgCanvas.keyPressed('L');
                            },
                        },
                        {
                            key: ['m', true], fn: function() {
                                svgCanvas.keyPressed('m');
                            },
                        },
                        {
                            key: ['shift+m', true], fn: function() {
                                svgCanvas.keyPressed('M');
                            },
                        },
                        {
                            key: ['n', true], fn: function() {
                                svgCanvas.keyPressed('n');
                            },
                        },
                        {
                            key: ['shift+n', true], fn: function() {
                                svgCanvas.keyPressed('N');
                            },
                        },
                        {
                            key: ['o', true], fn: function() {
                                svgCanvas.keyPressed('o');
                            },
                        },
                        {
                            key: ['shift+o', true], fn: function() {
                                svgCanvas.keyPressed('O');
                            },
                        },
                        {
                            key: ['p', true], fn: function() {
                                svgCanvas.keyPressed('p');
                            },
                        },
                        {
                            key: ['shift+p', true], fn: function() {
                                svgCanvas.keyPressed('P');
                            },
                        },
                        {
                            key: ['q', true], fn: function() {
                                svgCanvas.keyPressed('q');
                            },
                        },
                        {
                            key: ['shift+q', true], fn: function() {
                                svgCanvas.keyPressed('Q');
                            },
                        },
                        {
                            key: ['r', true], fn: function() {
                                svgCanvas.keyPressed('r');
                            },
                        },
                        {
                            key: ['shift+r', true], fn: function() {
                                svgCanvas.keyPressed('R');
                            },
                        },
                        {
                            key: ['s', true], fn: function() {
                                svgCanvas.keyPressed('s');
                            },
                        },
                        {
                            key: ['shift+s', true], fn: function() {
                                svgCanvas.keyPressed('S');
                            },
                        },
                        {
                            key: ['t', true], fn: function() {
                                svgCanvas.keyPressed('t');
                            },
                        },
                        {
                            key: ['shift+t', true], fn: function() {
                                svgCanvas.keyPressed('T');
                            },
                        },
                        {
                            key: ['u', true], fn: function() {
                                svgCanvas.keyPressed('u');
                            },
                        },
                        {
                            key: ['shift+u', true], fn: function() {
                                svgCanvas.keyPressed('U');
                            },
                        },
                        {
                            key: ['v', true], fn: function() {
                                svgCanvas.keyPressed('v');
                            },
                        },
                        {
                            key: ['shift+V', true], fn: function() {
                                svgCanvas.keyPressed('V');
                            },
                        },
                        {
                            key: ['w', true], fn: function() {
                                svgCanvas.keyPressed('w');
                            },
                        },
                        {
                            key: ['shift+w', true], fn: function() {
                                svgCanvas.keyPressed('W');
                            },
                        },
                        {
                            key: ['x', true], fn: function() {
                                svgCanvas.keyPressed('x');
                            },
                        },
                        {
                            key: ['shift+x', true], fn: function() {
                                svgCanvas.keyPressed('X');
                            },
                        },
                        {
                            key: ['y', true], fn: function() {
                                svgCanvas.keyPressed('y');
                            },
                        },
                        {
                            key: ['shift+y', true], fn: function() {
                                svgCanvas.keyPressed('Y');
                            },
                        },
                        {
                            key: ['z', true], fn: function() {
                                svgCanvas.keyPressed('z');
                            },
                        },
                        {
                            key: ['shift+Z', true], fn: function() {
                                svgCanvas.keyPressed('Z');
                            },
                        },
                        {
                            key: ['0', true], fn: function() {
                                svgCanvas.keyPressed('0');
                            },
                        },
                        {
                            key: ['1', true], fn: function() {
                                svgCanvas.keyPressed('1');
                            },
                        },
                        {
                            key: ['2', true], fn: function() {
                                svgCanvas.keyPressed('2');
                            },
                        },
                        {
                            key: ['3', true], fn: function() {
                                svgCanvas.keyPressed('3');
                            },
                        },
                        {
                            key: ['4', true], fn: function() {
                                svgCanvas.keyPressed('4');
                            },
                        },
                        {
                            key: ['5', true], fn: function() {
                                svgCanvas.keyPressed('5');
                            },
                        },
                        {
                            key: ['6', true], fn: function() {
                                svgCanvas.keyPressed('6');
                            },
                        },
                        {
                            key: ['7', true], fn: function() {
                                svgCanvas.keyPressed('7');
                            },
                        },
                        {
                            key: ['8', true], fn: function() {
                                svgCanvas.keyPressed('8');
                            },
                        },
                        {
                            key: ['9', true], fn: function() {
                        ...
                        {
                            key: ['ctrl+l', true], fn: function() {
                                var at = svgCanvas.toggleAutoSpacing();
                                alert('Auto-spacing is ' + (at ? 'on' : 'off') + '.');
                            },
                        },
                        ...
                        {
                            key: String.fromCharCode(189), fn: function() {
                                svgCanvas.keyPressed('−');
                            },
                        },
                        {
                            key: 'shift+(', fn: function() {
                                svgCanvas.keyPressed('(');
                            },
                        },
                        {
                        ...
                        {
                            key: [String.fromCharCode(61), true],
                            fn: function() {
                                svgCanvas.keyPressed('=');
                            },
                        },
                        {
                            key: ['shift+' + String.fromCharCode(43), true],
                            fn: function() {
                                svgCanvas.keyPressed('+');
                            },
                        },
                            ...
                            if (file.type.indexOf('image') !== -1) {
                                ...
                                reader.onloadend = function(e) {
                                    ...
                                    img.onload = function() {
                                        ...
                                        let insertWidth = imgWidth > 300 ? 300 : imgWidth;
                                        let insertHeight = imgWidth > 300 ? 300 * (imgHeight / imgWidth) : imgHeight;
